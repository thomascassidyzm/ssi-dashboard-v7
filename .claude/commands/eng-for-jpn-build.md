...
2. **Standalone-sayable** USE phrases — full sentences preferred, not required (Kai, 2026-08-17); the test is whether you could say it on its own in a conversation
...
6. **USE phrases you would not say on their own** — full sentences are preferred, not required, but a USE phrase must be standalone-sayable, and it always carries periods and scores.
