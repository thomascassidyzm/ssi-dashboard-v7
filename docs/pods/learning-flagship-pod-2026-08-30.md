...
**The read-out** (measured with the Method Pod's own instrument, §12): 11 chapters, figures in
§12 — same discipline as the control arms: every hold heard or named, a ≤4-word turn and an
`A → token → A` sandwich in every chapter, lopsided inside chapters, even across the set.
...
| 10 | *The pub* | A community is a learner — one sentence of Welsh and eighteen months of quiet | 2:22–80, 2:155–258, mission (community) | m19 **flagged digression and return** · m4 · m20 co-owned line · **the outsider's pitch** · O9 | callback → Ch. 2 (the pizza) · the detour clocked |
| 11 | *The layer above* | Education layer first, then everything else — and what still is not agreed | 4:21–474, 2:273–281 | N1 close · N8 recommendation on guarantee · m9 · m8 ×3 · the resisted goodbye | **callbacks → Ch. 1, Ch. 4, Ch. 9 — the fork named still standing** |
