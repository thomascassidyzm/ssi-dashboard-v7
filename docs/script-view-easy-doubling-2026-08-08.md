...
2026-08-08. Follow-on to `speaking-config-recut-2026-08-07.md`, which brought
Popty in line on the known-side syllable filter and deliberately left the
cycle-doubling out — so Script View understated an Easy round by about half.
