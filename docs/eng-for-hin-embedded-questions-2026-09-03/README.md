...
47 practice phrases across 10 seeds teach English that keeps interrogative inversion inside a
subordinate clause (`I don't know what would you like`). Two further rows in the same family are a
missing `if` and a known/target mismatch. All 49 are listed row by row with a proposed replacement.
...
| | |
|---|---|
| Rows read and confirmed as the defect | **47** across 10 seeds (569, 570, 631, 642, 644, 652, 657, 659, 664, 666, 667) |
...
| Extra rows found beyond the ~20 in the reading list | **+27** |
...
| Proposed replacement rows authored and gated | **49** (47 + 2 adjacent defects) |
| Proposed rows passing every gate | **49 of 49** |
...
| English clips needing re-recording | **0** — none of the 49 rows has any English audio |
| Hindi known-side clips that would go stale | **1** (s570 p2) |
...
I wrote the grammatically-correct version of all 47 and ran the course-builder's own target-side
...
- **(a) fix in place** — chosen for **1 row** (s569 p8, below): producible, gate-clean.
- **(b) rephrase to something producible teaching the same thing** — chosen for **47 rows**. Each
...
twice against production, second run with the 49 proposed rows substituted in memory:
...
Additional per-row gates on all 49 proposals (`gate-results.json`): vocabulary DP ✓, LEGO
...
explicit: *"Rewrites and deletions of phrases (report, don't apply silently — R0.3)."* 47 of the 49
rows are rewrites. The two that are plain grammar corrections (s569 p8, s644 p8) are ours by the
same table, but applying 2 of 49 leaves the course in a mixed state and gains a live learner nothing
while the other 47 wait on the same ruling.
...
| seed | pos | role | current English (WRONG) | proposed English | proposed Hindi cue | tiles |
|---|---|---|---|---|---|---|
| 569 | 6 | use | I don't know have you decided what happens | **have you decided what the answer is?** | क्या आपने फ़ैसला कर लिया है कि जवाब क्या है? | S0569L01 + S0017L03 |
| 569 | 8 | use | have you decided you were able to finish? | **have you decided if you were able to finish?** | क्या आपने फ़ैसला कर लिया है कि आप पूरा कर पाए या नहीं? | S0569L01 + S0049L03 + S0525L02 |
| 570 | 1 | build | can you tell me how much are you willing to pay for your ticket? | **how much are you willing to pay for your ticket today?** | आज आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0007L01 |
| 570 | 2 | build | I don't know how much are you willing to pay for your ticket | **how much are you willing to pay for your ticket this evening?** | आज शाम आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0018L03 |
| 570 | 4 | use | do you know how much are you willing to pay for your ticket? | **how much are you willing to pay for your ticket next month?** | अगले महीने आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0157L03 |
| 570 | 5 | use | I didn't know how much are you willing to pay for your ticket | **how much are you willing to pay for your ticket next year?** | अगले साल आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0176L01 |
| 570 | 6 | use | it doesn't matter how much are you willing to pay for your ticket | **how much are you willing to pay for your ticket at the weekend?** | सप्ताहांत में आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0214L02 |
| 570 | 7 | use | nobody was sure how much are you willing to pay for your ticket | **how much are you willing to pay for your ticket in a few minutes?** | कुछ मिनटों में आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0253L02 |
| 570 | 8 | use | have you decided how much are you willing to pay for your ticket? | **how much are you willing to pay for your ticket tomorrow morning?** | कल सुबह आप अपने टिकट के लिए कितना देने को तैयार हैं? | S0570L01 + S0155L04 |
| 631 | 4 | use | I don't know what would you like | **what would you like this evening?** | आज शाम आप क्या लेना चाहेंगे? | S0631L01 + S0018L03 |
| 631 | 5 | use | can you tell me what would you like? | **what would you like at the weekend?** | सप्ताहांत में आप क्या लेना चाहेंगे? | S0631L01 + S0214L02 |
| 631 | 6 | use | I didn't know what would you like | **what would you like tomorrow morning?** | कल सुबह आप क्या लेना चाहेंगे? | S0631L01 + S0155L04 |
| 631 | 7 | use | it doesn't matter what would you like | **what would you like in the pub?** | पब में आप क्या लेना चाहेंगे? | S0631L01 + S0118L03 |
| 631 | 8 | use | do you know what would you like? | **what would you like in a few minutes?** | कुछ मिनटों में आप क्या लेना चाहेंगे? | S0631L01 + S0253L02 |
| 642 | 4 | use | I don't know how do you feel | **how do you feel this morning?** | आज सुबह आप कैसा महसूस कर रही हैं? | S0642L01 + S0039L02 |
| 642 | 5 | use | can you tell me how do you feel? | **how do you feel at the weekend?** | सप्ताहांत में आप कैसा महसूस कर रही हैं? | S0642L01 + S0214L02 |
| 642 | 7 | use | I didn't know how do you feel | **how do you feel at work?** | काम पर आप कैसा महसूस कर रही हैं? | S0642L01 + S0185L02 |
| 642 | 8 | use | it doesn't matter how do you feel | **how do you feel today?** | आज आप कैसा महसूस कर रही हैं? | S0642L01 + S0007L01 |
| 644 | 6 | use | I don't know could you say that | **could you say that in English?** | अंग्रेज़ी में क्या आप वह कह सकते हैं? | S0644L01 + S0004L03 |
| 644 | 8 | use | could you say that for a little longer? | **could you say that for a little longer?** | थोड़ा और क्या आप वह कह सकते हैं? | S0644L01 + S0276L04 |
| 652 | 3 | build | I don't know what do you need sir | **what do you need sir this evening?** | आज शाम आपको किस चीज़ की ज़रूरत है, सर? | S0652L01 + S0018L03 |
| 652 | 4 | use | can you tell me what do you need sir? | **what do you need sir at the weekend?** | सप्ताहांत में आपको किस चीज़ की ज़रूरत है, सर? | S0652L01 + S0214L02 |
| 652 | 5 | use | I didn't know what do you need sir | **what do you need sir tomorrow morning?** | कल सुबह आपको किस चीज़ की ज़रूरत है, सर? | S0652L01 + S0155L04 |
| 652 | 6 | use | it doesn't matter what do you need sir | **what do you need sir in the office?** | ऑफ़िस में आपको किस चीज़ की ज़रूरत है, सर? | S0652L01 + S0184L02 |
| 652 | 7 | use | do you know what do you need sir? | **what do you need sir today?** | आज आपको किस चीज़ की ज़रूरत है, सर? | S0652L01 + S0007L01 |
| 657 | 3 | build | I don't know how do you all feel | **how do you all feel this morning?** | आज सुबह आप सब कैसा महसूस कर रहे हैं? | S0657L01 + S0039L02 |
| 657 | 4 | use | can you tell me how do you all feel? | **how do you all feel at the weekend?** | सप्ताहांत में आप सब कैसा महसूस कर रहे हैं? | S0657L01 + S0214L02 |
| 657 | 5 | use | I didn't know how do you all feel | **how do you all feel at work?** | काम पर आप सब कैसा महसूस कर रहे हैं? | S0657L01 + S0185L02 |
| 657 | 7 | use | it doesn't matter how do you all feel | **how do you all feel today?** | आज आप सब कैसा महसूस कर रहे हैं? | S0657L01 + S0007L01 |
| 657 | 8 | use | do you know how do you all feel? | **how do you all feel in the office?** | ऑफ़िस में आप सब कैसा महसूस कर रहे हैं? | S0657L01 + S0184L02 |
| 659 | 4 | use | I don't know could you all say that | **could you all say that in English?** | अंग्रेज़ी में क्या आप सब यह कह सकते हैं? | S0659L01 + S0004L03 |
| 659 | 8 | use | I didn't know could you all say that | **could you all say that quickly?** | जल्दी क्या आप सब यह कह सकते हैं? | S0659L01 + S0020L02 |
| 664 | 3 | build | I don't know are you all ready | **are you all ready this morning?** | आज सुबह क्या आप सब तैयार हैं? | S0664L01 + S0039L02 |
| 664 | 4 | use | can you tell me are you all ready? | **are you all ready at the weekend?** | सप्ताहांत में क्या आप सब तैयार हैं? | S0664L01 + S0214L02 |
| 664 | 6 | use | I didn't know are you all ready | **are you all ready tomorrow morning?** | कल सुबह क्या आप सब तैयार हैं? | S0664L01 + S0155L04 |
| 664 | 8 | use | it doesn't matter are you all ready | **are you all ready today?** | आज क्या आप सब तैयार हैं? | S0664L01 + S0007L01 |
| 666 | 2 | build | I don't know what do you all think | **what do you all think this evening?** | आज शाम आप सब क्या सोचते हैं? | S0666L01 + S0018L03 |
| 666 | 3 | build | can you tell me what do you all think? | **what do you all think at the weekend?** | सप्ताहांत में आप सब क्या सोचते हैं? | S0666L01 + S0214L02 |
| 666 | 4 | use | do you know what do you all think? | **what do you all think about the economy?** | अर्थव्यवस्था के बारे में आप सब क्या सोचते हैं? | S0666L01 + S0343L02 |
| 666 | 5 | use | I didn't know what do you all think | **what do you all think in the pub?** | पब में आप सब क्या सोचते हैं? | S0666L01 + S0118L03 |
| 666 | 6 | use | it doesn't matter what do you all think | **what do you all think today?** | आज आप सब क्या सोचते हैं? | S0666L01 + S0007L01 |
| 666 | 7 | use | we were talking about what do you all think | **what do you all think tomorrow morning?** | कल सुबह आप सब क्या सोचते हैं? | S0666L01 + S0155L04 |
| 666 | 8 | use | nobody was sure what do you all think | **what do you all think at work?** | काम पर आप सब क्या सोचते हैं? | S0666L01 + S0185L02 |
| 667 | 2 | build | I don't know do you all mind | **do you all mind this evening?** | आज शाम आप सबको आपत्ति तो नहीं है? | S0667L01 + S0018L03 |
| 667 | 3 | build | can you tell me do you all mind? | **do you all mind at the weekend?** | सप्ताहांत में आप सबको आपत्ति तो नहीं है? | S0667L01 + S0214L02 |
| 667 | 4 | use | do you know do you all mind? | **do you all mind tomorrow morning?** | कल सुबह आप सबको आपत्ति तो नहीं है? | S0667L01 + S0155L04 |
| 667 | 5 | use | I didn't know do you all mind | **do you all mind today?** | आज आप सबको आपत्ति तो नहीं है? | S0667L01 + S0007L01 |
| 667 | 6 | use | it doesn't matter do you all mind | **do you all mind in the office?** | ऑफ़िस में आप सबको आपत्ति तो नहीं है? | S0667L01 + S0184L02 |
| 667 | 8 | use | nobody was sure do you all mind | **do you all mind in a few minutes?** | कुछ मिनटों में आप सबको आपत्ति तो नहीं है? | S0667L01 + S0253L02 |

## 9. False positives — reported explicitly

**My scanner:** 55 candidates, 8 rejected → **14.5% false-positive rate.** All 8 are seed 262
(`so who was that man?`, `and who was that man you were talking to yesterday?`). These match
"wh-word + was + subject" but the wh-word *is* the subject and the clause is a main-clause question.
Rejected on reading, not on a rule.
...
**Coverage:** 1,103 phrases containing a subordinating trigger followed by a wh-word or auxiliary
were classified mechanically into inverted / bare-auxiliary / clean; the 47 in the first two buckets
were then read individually against their Hindi cue. The 1,056 classified clean were **not** read
one by one — that is the honest limit of this sweep's coverage.
...
Nothing generated, nothing queued to render. **0 English clips need re-recording** — not one of the
49 rows carries a `target1_audio_id` or `target2_audio_id`. One Hindi known-side clip
(s570 p2, `f3233c4b-263b-4b06-927d-caf1944691d6`) would go stale if the proposal is applied. The
course is all-xAI and xAI is retired, so nothing here is renderable today in any case.
