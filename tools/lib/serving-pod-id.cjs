...
// tool under tools/ used to build the pod id from a hard-coded slug; since Tom's
// ruling of 2026-09-13 ("There is only pod-1 now") the serving rule lives once in
// tools/pods/serving-slug.cjs and this is the one-line way to ask it for a pod id. A course with no serving core pod is a NAMED failure, not a
// guessed slug.
