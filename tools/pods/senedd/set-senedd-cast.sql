...
-- cartesia_8fef4d59-0a7e-4ad2-a261-6a3bb50734d2 (display name tom_001), Tom's
...
UPDATE listening_pods SET speakers = jsonb_build_object(
  'Delyth Jewell', jsonb_build_object('gender','m','variants', jsonb_build_array('Delyth Jewell'),
      ...
      'known',  jsonb_build_object('name','Tom','provider','cartesia','locale','en-GB','voice_id','cartesia_8fef4d59-0a7e-4ad2-a261-6a3bb50734d2')),
