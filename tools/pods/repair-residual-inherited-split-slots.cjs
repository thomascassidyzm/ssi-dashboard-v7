 ...
 * in-cast, and coherent with the row's OWN text by the same six-column check
...
async function main () {
  ...
  console.log(`measured inherited slots, all six-column populations: ${JSON.stringify(measuredTotals)}`)
