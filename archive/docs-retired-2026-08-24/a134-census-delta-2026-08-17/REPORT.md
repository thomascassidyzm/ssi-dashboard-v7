# A-134 — the 18-row census delta, repaired and live (eng_for_sin)
...
|---|---|---|---|---|
| `S0216L01B03` | 216 | මමා යාළුවන් ටිකක් ඒ ගෙදරදී | **යාළුවන් ටිකක් ඒ ගෙදරදී** | a few friends at home |
| `S0226L01U03` | 226 | a මිනිහා මමා ලවා ඒ ගෙදරදී කිව්වා | **මිනිහා මාව ලවා ඒ ගෙදරදී කිව්වා** | a man told me at home |
| `S0233L01U02` | 233 | ඔයාගේ අක්කාව දන්නා මිනිහෙකු ममා දන්නවා | **ඔයාගේ අක්කාව දන්නා මිනිහෙකු මම දන්නවා** | I know a man who knows your sister |
| `S0241L01B02` | 241 | ममා ඒක ඔහු ලවා දෙන්නේ ඕනේ | **මම ඒක ඔහු ලවා දෙන්නේ ඕනේ** | I want to give it to him |
| `S0420L03U01` | 420 | ඔහු කොච්චර කාලද ිකියලා ඒ අයට ඇහෙන්නේ ඕනෑ නෑ | **ඔහු කොච්චර කාලද කියලා ඒ අයට ඇහෙන්නේ ඕනෑ නෑ** | they don't need to hear how long he stayed |
...
| `S0398L01U02` | 398 | ඔහුට ඕනේ අපිේ ළමාවිල | **ඔහුට ඕනේ අපේ ළමයි** | he wants our children |
| `S0398L01U01` | 398 | මට ඕනේ අපිේ ළමාවිල | **මට ඕනේ අපේ ළමයි** | I want our children |
| `S0398L01B03` | 398 | අපිේ ළමාවිල කිව්ව | **අපේ ළමයි කිව්ව** | said our children |
| `S0398L03U01` | 398 | අපිේ ළමාවිල ගොඩ ඉවසිලිවන්ත වෙන්නයි අපිට ඕනේ | **අපේ ළමයි ගොඩ ඉවසිලිවන්ත වෙන්නයි අපිට ඕනේ** | we want to become more patient with our children |
| `S0398L01U05` | 398 | ඒ අයට ඕනේ අපිේ ළමාවිල | **ඒ අයට ඕනේ අපේ ළමයි** | they want our children |
| `S0398L02B04` | 398 | අපිේ ළමාවිල ගොඩ ඉවසිලිවන්ත වෙන්නයි | **අපේ ළමයි ගොඩ ඉවසිලිවන්ත වෙන්නයි** | to become more patient with our children |
| `S0398L01U03` | 398 | ඇය කිව්ව අපිේ ළමාවිල | **ඇය කිව්ව අපේ ළමයි** | she talked about our children |
| `S0398L01B02` | 398 | අපිේ ළමාවිල ඕනේ | **අපේ ළමයි ඕනේ** | want our children |
| `S0398L01U04` | 398 | මම හිතනවා අපිේ ළමාවිල | **මම හිතනවා අපේ ළමයි** | I think about our children |
| `S0398L01B01` | 398 | අපිේ ළමාවිල ලෙයිකයි | **අපේ ළමයි ලෙයිකයි** | liked our children |
| `8c4d2b33-5371-4cea-98e7-221b86eaa0bd` | 398 | අපිේ ළමාවිල | **අපේ ළමයි** | our children |
| `seed398` | 398 | අපිේ ළමාවිල ගොඩ ඉවසිලිවන්ත වෙන්නයි අපිට ඕනේ. | **අපේ ළමයි ගොඩ ඉවසිලිවන්ත වෙන්නයි අපිට ඕනේ.** | We want to become more patient with our children. |
...
| row | seed | was | now | English |
|---|---|---|---|---|
| `S0151L01U05` | 151 | මම ආශා කළ දේ මම ඔයාව දිකිනකොට | **මම ආශා කළ දේ මම ඔයාව දකිනකොට** | what I was hoping was when I saw you |
...
| row | seed | was | now | English |
|---|---|---|---|---|
| `S0121L03U08` | 121 | ෙමෙක ගාඩිය ආශා නෑ කියලා අසාමාන්‍ය | **ඔයා ගාඩිය ආශා නෑ කියලා අසාමාන්‍ය** | it's unusual that you don't like the car |
| `S0061L03B03` | 61 | ආයෙ ෙ ටිකක් කියන්න පුළුවන්ද | **ආයෙ ටිකක් කියන්න පුළුවන්ද** | could you say that a little again? |
| `S0118L02U08` | 118 | මMA ශාලාවේ ඉන්නකොට හොඳ දැනෙනවාට | **මම ශාලාවේ ඉන්නකොට හොඳ දැනෙනවාට** | I felt better when we were in the pub |

## Per-row confidence and reasoning

| row | group | confidence | why |
|---|---|---|---|
| `S0216L01B03` | G1 | high | Deleted the corrupt token rather than substituting "I". The authored English has no first person, and siblings B01/B02/U01 show the bare noun phrase. **Overturns the brief.** A sibling worker independently made the identical edit while this job was running. |
| `S0226L01U03` | G1 | high | Two defects. The stray Latin article dropped (Sinhala has no article, and the indefinite මිනිහෙක් is not introduced until seed 230 — using it here would have broken the ordering rail). The corrupt token became the accusative "me", not the subject pronoun: the subject form occurs **0 times** in the whole course, the accusative **79 times**, and all four sibling rows at this seed use it. **Overturns the brief.** A sibling worker independently made the same accusative correction mid-job. |
| `S0233L01U02` | G1 | high | Devanagari → Sinhala. The sibling row S0233L01U03 is the same sentence with the correct pronoun in the same slot. |
| `S0241L01B02` | G1 | high | Devanagari → Sinhala. Sibling U05 is the same sentence differing only in tense. |
| `S0420L03U01` | G1 | high | Orphan leading vowel sign stripped; the result is a token attested in 806 phrases. |
| `S0121L03U08` | G3 | high | Not recoverable as a visual-order artefact — no reordering of those four codepoints yields a word. The answer comes from the row next door: sibling U07 is the *same sentence frame* with "you" in slot 0, and seed 121 itself opens with it. |
| `S0061L03B03` | G3 | medium | Orphan vowel sign deleted rather than expanded. Sibling U02 renders the English "that" with **no** Sinhala counterpart in this exact frame, so deletion matches the course's own convention. Runner-up (rejected): insert the demonstrative, whose position would have been dictated by where the corrupt glyph happened to sit — not evidence. |
| `S0151L01U05` | G4 | medium-high | **Clearance overturned.** See §4. |
| `S0118L02U08` | EXTRA | high | Found by my own re-derivation; the census missed it. Latin-glyph mangling of the first-person pronoun. All 7 sibling rows on this card open with the correct pronoun. |
