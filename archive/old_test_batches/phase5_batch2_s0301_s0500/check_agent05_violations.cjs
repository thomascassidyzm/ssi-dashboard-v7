...
const agent05 = JSON.parse(fs.readFileSync('batch_output/agent_05_baskets.json', 'utf8'));
const seeds = agent05.seeds || agent05;
...
console.log(`Agent 05: ${total} total violations\n`);
console.log('Violating words:');
