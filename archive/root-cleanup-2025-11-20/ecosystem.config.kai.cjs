/**
 * PM2 Ecosystem Configuration - KAI'S MACHINE
 *
 * Manages automation server, dashboard UI, and ngrok tunnel for Kai's machine
 *
 * Usage:
...
module.exports = {
  apps: [
    ...
    },
    {
      name: 'ngrok-tunnel',
      script: 'ngrok',
      args: 'http --domain=kai-lizard-function.ngrok-free.dev 3456',
      cwd: __dirname,
      instances: 1,
      autorestart: true,
      watch: false,
