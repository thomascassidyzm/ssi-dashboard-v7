...
const SEEDS = ['S0121', 'S0122', 'S0123', 'S0124', 'S0125', 'S0126', 'S0127', 'S0128', 'S0129', 'S0130'];
...
function generatePhrases(legoEnglish, legoTarget, whitelist, isFinalLego, seedEnglish, seedTarget, legoComponents, currentSeedEarlierLegos) {
  ...
  if (isFinalLego) {
    ...
    phrases = phrases.slice(0, 9); // Keep only first 9
...
async function main() {
  ...
  console.log('║  Processing Seeds S0121-S0130 (10 seeds)                   ║');
