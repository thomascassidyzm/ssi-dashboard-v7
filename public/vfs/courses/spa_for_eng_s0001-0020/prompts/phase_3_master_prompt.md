...
1. **Spawn 1 parallel agents** to extract LEGOs from all 20 seeds
...
`/Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0020/phase3_scaffolds/agent_01.json` through `agent_01.json`
...
```markdown
You are LEGO Extraction Agent 1.

## Your Data
**Scaffold**: Read `/Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0020/phase3_scaffolds/agent_XX.json`
...
## Output
Write to: `/Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0020/phase3_outputs/agent_XX_provisional.json`
...
cat > public/vfs/courses/spa_for_eng_s0001-0020/phase3_outputs/.progress.json << 'EOF'
{
  "phase": "phase3",
  "status": "in_progress",
  "completed_agents": 1,
...
git add public/vfs/courses/spa_for_eng_s0001-0020/phase3_outputs/.progress.json
git commit -m "Phase 3 progress: 1/1 agents complete"
git push origin main
```

**Update this file each time an agent completes** so users can see real-time progress!

When all 1 agents finish:

1. **PUSH TO GITHUB IMMEDIATELY** (critical for automation):

```bash
git add .
git commit -m "Phase 3: LEGO extraction complete for spa_for_eng_s0001-0020

- Extracted LEGOs for 20 seeds
- 1 parallel agents
- Ready for merge and validation"

git push origin HEAD:claude/phase3-spa_for_eng_s0001-0020-$(date +%s)
```
...
- Run the merge script: `node scripts/phase3_merge_legos.cjs /Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0020`
- Continue to Phase 5
