...
Translate all 30 canonical seeds into Spanish and English using 1 parallel agents.
...
## Output
Write to: `/Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0030/translations/agent_01_translations.json`
...
```bash
node scripts/merge_phase1_translations.cjs /Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0030
```

Expected output: `/Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0030/seed_pairs.json` with all 30 translations.
...
```bash
git add /Users/tomcassidy/SSi/ssi-dashboard-v7-clean/public/vfs/courses/spa_for_eng_s0001-0030/seed_pairs.json
git commit -m "Phase 1: 30 translations for spa_for_eng_s0001-0030"
