      ...
      <div class="page-header">
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="ml-4 space-y-1 text-ink">
                    <p class="text-sm"><span class="text-emerald-400 font-mono">lo mas</span> = <span class="text-ink">"the most"</span></p>
                    <p class="text-sm"><span class="text-emerald-400 font-mono">frecuentemente</span> = <span class="text-ink">"often"</span></p>
                    <p class="text-sm"><span class="text-emerald-400 font-mono">posible</span> = <span class="text-ink">"possible"</span></p>
                  </div>
                </div>
        ...
        <section class="mb-12">
          ...
          <div class="bg-surface border border-line rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
              <!-- BUILD phrases -->
              <div class="bg-canvas p-4 rounded border-l-4 border-blue-500">
              ...
              <!-- USE phrases -->
              <div class="bg-canvas p-4 rounded border-l-4 border-emerald-500">
                <div class="flex items-start justify-between mb-2">
