  ...
  <section class="bg-surface/50 rounded-lg border border-line/20 p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      ...
      <div class="bg-canvas/50 rounded-lg p-4 text-center border border-line">
        <div class="text-3xl font-bold text-ink">
          <span v-if="loading" class="inline-block w-6 h-6 border-2 border-line border-t-slate-300 rounded-full animate-spin"></span>
      ...
      <!-- Generated -->
      <div class="bg-canvas/50 rounded-lg p-4 text-center border border-emerald-500/30">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <CostEstimate
        ...
        :actual="actualCost"
      />
      <div v-else class="bg-canvas/30 rounded-lg p-4 border border-line">
