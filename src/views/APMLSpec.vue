    ...
    <header class="bg-slate-800/50 border-b border-slate-400/10 backdrop-blur-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <h1 class="text-3xl font-bold text-emerald-400">
          APML v11.2.0 Specification
        </h1>
        <p class="mt-2 text-slate-400">
          Audio-first pipeline: Phase 1 → Phase 2 → Phase 3 → Audio → Manifest
        </p>
        <p class="mt-1 text-xs text-slate-500">
          Build: v11.2.0 | Dec 12, 2025
        </p>
      </div>
    </header>
      ...
      <div class="bg-slate-800/50 rounded-lg border border-slate-400/20 p-8">
        ...
        <section class="mb-8">
          ...
          <div class="prose prose-invert prose-emerald max-w-none text-slate-300">
            <p><strong>APML (Adaptive Pedagogy Markup Language)</strong> v11.2.0 is the current architectural specification for the SSi Course Production system. It introduces an audio-first pipeline (Phase 1 → Phase 2 → Phase 3 → Audio → Manifest) with Supabase as the database layer. A phase triggers agents. Scripts run instantly.</p>
