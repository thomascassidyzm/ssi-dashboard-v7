  ...
  <div class="lab">
    <header class="lab-header">
      <nav class="admin-crumbs">
        ...
        <span class="crumb-here">VOICELAB</span>
      </nav>
      <h1 class="page-title">VOICELAB</h1>
      <p class="page-subtitle">
        A bench, not a picker. Audition voices on real course sentences, compare providers on
        identical text, declare one voice per course side, and read whether a side has stayed
        one person.
        <strong>Every audition plays from the store first — a take that already exists costs nothing.</strong>
      </p>
    </header>
