...
const cards = [
  ...
  },
  {
    ...
    badge: 'voice',
    description: 'Audition voices on real course sentences, compare providers on identical text, declare one voice per course side, and read the drift report that says whether a side has stayed one person.',
    action: 'Open VOICELAB',
    accent: '#ec4899',
