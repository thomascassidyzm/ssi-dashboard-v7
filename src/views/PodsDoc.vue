      ...
      <div class="bg-surface rounded-lg border border-line shadow-sm p-8 mb-8">
        ...
        <div class="text-ink">
          ...
          <ul class="space-y-2 mb-4 list-disc pl-5 text-muted">
            <li><strong class="text-ink">Core pod</strong> (<code class="font-mono">pod-1</code> on every course) - every learner does this one. Whether a course has one is a per-course fact: resolve it, never assume it.</li>
