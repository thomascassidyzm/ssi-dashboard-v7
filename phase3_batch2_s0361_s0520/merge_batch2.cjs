...
/**
 * Merge Batch 2: S0361-S0520 LEGO Extraction
...
console.log('🔀 Merging Batch 2: S0361-S0520');
console.log('='.repeat(60));

const BATCH_OUTPUT_DIR = path.join(__dirname, 'batch_output');
const REGISTRY_FILE = path.join(__dirname, 'registry', 'lego_registry_s0001_s0360.json');
const OUTPUT_FILE = path.join(__dirname, 'lego_pairs_s0361_s0520.json');

// Load registry
console.log('📖 Loading S0001-S0360 registry...');
...
const finalSeeds = [];
let cumulativeNewLEGOs = registry.total_legos; // Start from S0001-S0360 count
...
console.log(`Cumulative total (S0001-S0520): ${cumulativeNewLEGOs}`);
...
const output = {
  ...
  seed_range: "S0361-S0520",
  batch_number: 2,
  cumulative_range: "S0001-S0520",
