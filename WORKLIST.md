...
- [~] @claude-self-explaining 07-27 **Popty self-explaining v1 — compiled explainer (second proof of 'apps ship with explanatory power'; first = ssi-learning-app 2026-07-27). Compiler + drift gate + persona packs (admin/editor/recorder + dev/agent file renders) + noticing rules.** → `docs/self-explaining-popty.md`
