...
- [ ] **zho v2 generation run** using the encoded prompt + gates. **Size decided (Tom 06-14):** prove on **seeds 1–150** first, eyeball, then scale to the **full 668**. NB v1 is already **668 seeds fully decomposed but 100% `status=draft`** (1183 legos / 11905 phrases, 0 released); the "~350 MVP" is the *served* manifest, not the DB. → `docs/course-optimization/WORKLIST.md`
