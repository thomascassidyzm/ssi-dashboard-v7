# Translate encouragement messages to Thai
...
2. **"your new language"** — translate naturally as the equivalent phrase in Thai (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Thai" or "English".
...
6. **"press-ups"** — use whatever term is natural in Thai (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Thai is more important than literal accuracy
...
**Thai:**
ตอนนี้ สิ่งที่คุณทำอยู่นี้เป็นงานหนักมากสำหรับสมอง—นั่นคือวิธีที่มันทำให้คุณเรียนรู้เร็วมาก—ดังนั้นเป็นครั้งคราว ฉันจะให้คุณพักผ่อนเล็กน้อยและบอกบางสิ่งเกี่ยวกับการเดินทางนี้ที่จะช่วยให้คุณประสบความสำเร็จ ก่อนอื่น คุณรู้ไหมว่าสมองของคุณมีประมาณหนึ่งแสนล้านเซลล์ประสาท? นั่นเท่ากับจำนวนดาวในกาแล็กซี่ข...
...
**Thai:**
ตอนนี้ ฉันขอให้คุณทำผิดพลาด และถ้าคุณเหมือนคนส่วนใหญ่ คุณไม่ชอบทำผิดพลาด คุณอาจถูกบอกที่โรงเรียนว่าความผิดพลาดเป็นสิ่งไม่ดี แต่เมื่อคุณกำลังเรียนภาษาใหม่ ความผิดพลาดเป็นสิ่งดี มีความผิดพลาดแค่สองประเภท—ประเภทแรกคือที่คุณไม่สังเกตเห็น ซึ่งไม่ใช่ปัญหาเพราะคุณไม่สังเกตเห็น ประเภทที่สองคือที่คุณสังเกตว่...
...
**Thai:** ถ้าคุณไม่ทำผิดพลาดเลย นั่นหมายความว่ามันง่ายเกินไปสำหรับคุณ—บางทีคุณควรลอง ข้าม ข้ามไปข้างหน้า!
...
**Thai:** จำไว้ว่าคุณต้องพูดออกเสียงดังๆ ในช่วงเว้นจังหวะ—แม้ว่าคุณจะพูดทั้งประโยคไม่ได้ ก็พูดคำให้มากเท่าที่ทำได้
...
**Thai:** สิ่งสำคัญคือต้องเล่นกับภาษา ทำให้มันสนุก ดังนั้นอย่าจริงจังกับตัวเองมากเกินไป และลองหัวเราะเมื่อมีอะไรผิดพลาด—ยิ่งรู้สึกสนุก คุณก็จะเรียนรู้เร็วขึ้น
