# Translate encouragement messages to Danish
...
2. **"your new language"** — translate naturally as the equivalent phrase in Danish (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Danish" or "English".
...
6. **"press-ups"** — use whatever term is natural in Danish (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Danish is more important than literal accuracy
...
**Danish:**
Det, du gør her, er meget hårdt arbejde for hjernen—det er sådan, den får dig til at lære så hurtigt—så ind imellem vil jeg give dig en lille pause og fortælle dig nogle ting om denne rejse, der vil hjælpe dig med at få succes. Først og fremmest, vidste du, at din hjerne har omkring 100 milliarder n...
...
**Danish:**
Nu har jeg bedt dig om at lave fejl, og hvis du er som de fleste mennesker, kan du ikke lide at lave fejl. Du fik sandsynligvis at vide i skolen, at fejl er dårlige. Men når du lærer et nyt sprog, er fejl gode. Der er kun to typer fejl—de første er dem, du ikke bemærker, som ikke er et problem, ford...
...
**Danish:** Hvis du ikke laver fejl, betyder det, at det er for nemt for dig—måske burde du prøve at bruge Spring over for at komme videre!
...
**Danish:** Husk at du skal tale højt i pausen—selvom du ikke kan sige hele sætningen, så sig så mange ord, du kan.
...
**Danish:** Det er vigtigt at lege med sproget, at gøre det sjovt, så tag ikke dig selv for alvorligt, og prøv at grine, når noget går galt—jo sjovere det føles, jo hurtigere vil du komme fremad.
