# Translate encouragement messages to Norwegian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Norwegian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Norwegian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Norwegian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Norwegian is more important than literal accuracy
...
**Norwegian:**
Det du gjør her er veldig hardt arbeid for hjernen—det er sånn den får deg til å lære så raskt—så innimellom vil jeg gi deg en liten pause og fortelle deg noen ting om denne reisen som vil hjelpe deg å lykkes. Først av alt, visste du at hjernen din har omtrent 100 milliarder nevroner? Det er omtrent...
...
**Norwegian:**
Nå har jeg bedt deg om å gjøre feil, og hvis du er som de fleste mennesker, liker du ikke å gjøre feil. Du ble sannsynligvis fortalt på skolen at feil er dårlige. Men når du lærer et nytt språk, er feil bra. Det finnes bare to typer feil—de første er de du ikke merker, som ikke er et problem fordi d...
...
**Norwegian:** Hvis du ikke gjør feil, betyr det at det er for enkelt for deg—kanskje du burde prøve å bruke Hopp over for å komme videre!
...
**Norwegian:** Husk at du må snakke høyt i pausen—selv om du ikke kan si hele setningen, si så mange ord du kan.
...
**Norwegian:** Det er viktig å leke med språket, å gjøre det morsomt, så ikke ta deg selv for alvorlig, og prøv å le når noe går galt—jo morsommere det føles, jo raskere vil du komme fremover.
