# Translate encouragement messages to Belarusian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Belarusian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Belarusian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Belarusian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Belarusian is more important than literal accuracy
...
**Belarusian:**
Такім чынам, тое, што ты тут робіш—гэта вельмі цяжкая праца для мозгу—менавіта так ён прымушае цябе так хутка вучыцца—таму час ад часу я буду даваць табе невялікую перапынак і расказваць пра некаторыя рэчы на гэтым шляху, якія дапамогуць табе дасягнуць поспеху. Перш за ўсё, ці ведаў ты, што ў тваім ...
...
**Belarusian:**
Цяпер, я прасіў цябе рабіць памылкі, і калі ты падобны да большасці людзей, ты не любіш рабіць памылкі. Табе, напэўна, казалі ў школе, што памылкі—гэта дрэнна. Але калі ты вывучаеш новую мову, памылкі—гэта добра. Ёсць толькі два віды памылак—першыя—гэта тыя, якія ты не заўважаеш, што не з'яўляецца п...
...
**Belarusian:** Калі ты не робіш памылак, гэта значыць, што гэта занадта лёгка для цябе—магчыма, табе варта паспрабаваць Прапусціць наперад!
...
**Belarusian:** Памятай, што табе трэба гаварыць уголас у паўзе—нават калі ты не можаш сказаць увесь сказ, скажы столькі слоў, колькі можаш.
...
**Belarusian:** Важна гуляць з мовай, рабіць яе весялейшай, таму не ўспрымай сябе занадта сур'ёзна і паспрабуй смяяцца, калі нешта ідзе не так—чым больш пацешна гэта адчуваецца, тым хутчэй ты будзеш прасоўвацца.
