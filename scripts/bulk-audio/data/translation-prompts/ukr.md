# Translate encouragement messages to Ukrainian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Ukrainian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Ukrainian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Ukrainian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Ukrainian is more important than literal accuracy
...
**Ukrainian:**
Отже, те, що ти тут робиш — це дуже важка робота для мозку, саме так він змушує тебе вчитися так швидко — тому час від часу я буду давати тобі невелику перерву і розповідати дещо про цю подорож, що допоможе тобі досягти успіху. По-перше, чи знав ти, що у твоєму мозку близько 100 мільярдів нейронів? ...
...
**Ukrainian:**
Отже, я просив тебе робити помилки, і якщо ти як більшість людей, тобі не подобається робити помилки. Тобі, напевно, казали в школі, що помилки — це погано. Але коли ти вчиш нову мову, помилки — це добре. Є тільки два види помилок — перші це ті, які ти не помічаєш, що не є проблемою, бо ти їх не пом...
...
**Ukrainian:** Якщо ти не робиш помилок, це означає, що для тебе це занадто легко — може, варто спробувати Пропустити і рухатися далі!
...
**Ukrainian:** Пам'ятай, що тобі потрібно говорити вголос у паузі — навіть якщо не можеш сказати все речення, скажи стільки слів, скільки зможеш.
...
**Ukrainian:** Важливо гратися з мовою, робити це веселим, тож не стався до себе занадто серйозно і намагайся сміятися, коли щось йде не так — чим смішніше тобі буде, тим швидше ти підеш.
