# Translate encouragement messages to Polish
...
2. **"your new language"** — translate naturally as the equivalent phrase in Polish (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Polish" or "English".
...
6. **"press-ups"** — use whatever term is natural in Polish (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Polish is more important than literal accuracy
...
**Polish:**
Więc to, co tutaj robisz, to bardzo ciężka praca dla mózgu — tak właśnie sprawia, że uczysz się tak szybko — więc od czasu do czasu dam ci małą przerwę i opowiem ci kilka rzeczy o tej podróży, które pomogą ci odnieść sukces. Po pierwsze, czy wiedziałeś, że twój mózg ma około 100 miliardów neuronów? ...
...
**Polish:**
Więc prosiłem cię o robienie błędów, a jeśli jesteś jak większość ludzi, nie lubisz robić błędów. Prawdopodobnie mówiono ci w szkole, że błędy są złe. Ale gdy uczysz się nowego języka, błędy są dobre. Są tylko dwa rodzaje błędów — pierwsze to te, których nie zauważasz, co nie jest problemem, bo ich ...
...
**Polish:** Jeśli nie robisz błędów, to znaczy, że jest dla ciebie zbyt łatwo — może powinieneś spróbować Pomiń i przejść dalej!
...
**Polish:** Pamiętaj, że musisz mówić na głos w przerwie — nawet jeśli nie możesz powiedzieć całego zdania, powiedz tyle słów, ile zdołasz.
...
**Polish:** Ważne jest, żeby bawić się językiem, żeby było zabawnie, więc nie traktuj siebie zbyt poważnie i staraj się śmiać, gdy coś idzie nie tak — im zabawniej ci będzie, tym szybciej pójdziesz.
