# Translate encouragement messages to Estonian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Estonian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Estonian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Estonian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Estonian is more important than literal accuracy
...
**Estonian:**
Nii, see, mida sa siin teed, on ajule väga raske töö—sellepärast sa õpidki nii kiiresti—nii et aeg-ajalt annan ma sulle väikese pausi ja räägin sulle mõnest asjast sellel teekonnal, mis aitavad sul edu saavutada. Esiteks, kas sa teadsid, et sinu ajus on umbes 100 miljardit neuronit? See on umbes sam...
...
**Estonian:**
Nüüd, ma olen palunud sul vigu teha, ja kui sa oled nagu enamik inimesi, siis sulle ei meeldi vigu teha. Sulle öeldi ilmselt koolis, et vead on halvad. Aga kui sa õpid uut keelt, on vead head. On ainult kahte tüüpi vigu—esimesed on need, mida sa ei märka, mis pole probleem, sest sa ei märka neid. Te...
...
**Estonian:** Kui sa ei tee vigu, tähendab see, et see on sinu jaoks liiga lihtne—võib-olla peaksid proovima HÜPATA edasi!
...
**Estonian:** Pea meeles, et sa pead pausi ajal valjusti rääkima—isegi kui sa ei suuda kogu lauset öelda, ütle nii palju sõnu kui võimalik.
...
**Estonian:** Oluline on keelega mängida, teha sellest lõbus, nii et ära võta ennast liiga tõsiselt, ja püüa naerda, kui midagi valesti läheb—mida lõbusamalt see tundub, seda kiiremini sa edened.
