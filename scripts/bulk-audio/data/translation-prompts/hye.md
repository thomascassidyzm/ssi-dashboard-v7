# Translate encouragement messages to Armenian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Armenian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Armenian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Armenian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Armenian is more important than literal accuracy
...
**Armenian:**
Հիմա այն, ինչ դու այստեղ անում ես, ուղեղի համար շատ ծանր աշխատանք է, և հենց դրա շնորհիվ է, որ դու այսքան արագ ես սովորում։ Երբեմն ես քեզ մի փոքր ընդմիջում կտամ և կպատմեմ այս ճանապարհի մասին բաներ, որոնք կօգնեն քեզ հաջողել։ Նախ՝ գիտե՞իր, որ քո ուղեղում մոտ 100 միլիարդ նեյրոն կա։ Դա մոտավորապես այնքան...
...
**Armenian:**
Եկ հիմա վերջապես խոսենք այդ 10% կանոնի մասին։ Այն շատ պարզ է։ Եթե առաջադրանքը չափազանց հեշտ է, ուղեղդ չի փոխվում։ Եթե այն չափազանց դժվար է, ուղեղդ հանձնվում է։ Բայց եթե այն ճիշտ այնքան դժվար է, որ դու մոտ 10% ժամանակ սխալվես, ուղեղդ մտնում է օպտիմալ սովորելու ռեժիմ։ Դա այն գոտին է, որտեղ նոր կապերը ...
...
**Armenian:** Եթե սխալներ չես անում, դա նշանակում է, որ քեզ համար շատ հեշտ է․ գուցե պետք է փորձես Բաց'ել առաջ։
...
**Armenian:** Հիշիր, որ բացման ժամանակ պետք է բարձրաձայն խոսես—even եթե չես կարող ասել ամբողջ նախադասությունը, ասա հնարավորինս շատ բառեր։
...
**Armenian:** Շատ կարևոր է լեզվով խաղալը, այն զվարճալի դարձնելը, այնպես որ քեզ շատ լուրջ մի ընդունիր և փորձիր ծիծաղել, երբ ինչ-որ բան սխալ է գնում․ որքան զվարճալի լինի, այնքան արագ կգնաս առաջ։
