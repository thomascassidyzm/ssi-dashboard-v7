# Translate encouragement messages to Catalan
...
2. **"your new language"** — translate naturally as the equivalent phrase in Catalan (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Catalan" or "English".
...
6. **"press-ups"** — use whatever term is natural in Catalan (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Catalan is more important than literal accuracy
...
**Catalan:**
El que estàs fent aquí és una feina molt dura per al cervell—és així com et fa aprendre tan ràpidament—així que de tant en tant, et donaré una petita pausa i t'explicaré algunes coses sobre aquest viatge que t'ajudaran a tenir èxit. Primer de tot, sabies que el teu cervell té uns 100 mil milions de ...
...
**Catalan:**
T'he estat demanant que cometis errors, i si ets com la majoria de la gent, no t'agrada cometre errors. Probablement a l'escola et van dir que els errors són dolents. Però quan estàs aprenent una nova llengua, els errors són bons. Només hi ha dos tipus d'errors—els primers són els que no notes, que ...
...
**Catalan:** Si no estàs cometent errors, vol dir que és massa fàcil per a tu—potser hauries de provar d'utilitzar Salta per avançar!
...
**Catalan:** Recorda que has de parlar en veu alta durant la pausa—encara que no puguis dir tota la frase, digues tantes paraules com puguis.
...
**Catalan:** És important jugar amb la llengua, fer-la divertida, així que no et prenguis massa seriosament, i prova de riure quan alguna cosa vagi malament—com més divertit et sembli, més ràpid avançaràs.
