# Translate encouragement messages to Slovak
...
2. **"your new language"** — translate naturally as the equivalent phrase in Slovak (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Slovak" or "English".
...
6. **"press-ups"** — use whatever term is natural in Slovak (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Slovak is more important than literal accuracy
...
**Slovak:**
Takže to, čo tu robíš, je pre mozog veľmi ťažká práca — tak ťa núti učiť sa tak rýchlo — takže ti občas dám malú pauzu a poviem ti pár vecí o tejto ceste, ktoré ti pomôžu k úspechu. Po prvé, vedel si, že tvoj mozog má asi 100 miliárd neurónov? To je približne toľko neurónov, koľko je hviezd v našej ...
...
**Slovak:**
Takže som ťa žiadal, aby si robil chyby, a ak si ako väčšina ľudí, nerád robíš chyby. Pravdepodobne ti v škole hovorili, že chyby sú zlé. Ale keď sa učíš nový jazyk, chyby sú dobré. Sú len dva druhy chýb — prvé sú tie, ktorých si nevšimneš, čo nie je problém, pretože si ich nevšimneš. Druhé sú tie, ...
...
**Slovak:** Ak nerobíš chyby, znamená to, že je to pre teba príliš ľahké — možno by si mal skúsiť Preskočiť a posunúť sa ďalej!
...
**Slovak:** Pamätaj, že musíš v pauze hovoriť nahlas — aj keď nemôžeš povedať celú vetu, povedz toľko slov, koľko zvládneš.
...
**Slovak:** Je dôležité si s jazykom hrať, aby to bola zábava, takže sa neber príliš vážne a snaž sa smiať, keď niečo nejde — čím viac zábavy ti to príde, tým rýchlejšie to pôjde.
