# Translate encouragement messages to German
...
2. **"your new language"** — translate naturally as the equivalent phrase in German (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "German" or "English".
...
6. **"press-ups"** — use whatever term is natural in German (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural German is more important than literal accuracy
...
**German:**
Also, was du hier machst, ist sehr harte Arbeit für das Gehirn—so bringt es dich dazu, so schnell zu lernen—also werde ich dir ab und zu eine kleine Pause gönnen und dir einige Dinge über diese Reise erzählen, die dir zum Erfolg verhelfen werden. Erstens, wusstest du, dass dein Gehirn etwa 100 Milli...
...
**German:**
Nun, ich habe dich gebeten, Fehler zu machen, und wenn du wie die meisten Menschen bist, magst du es nicht, Fehler zu machen. Man hat dir wahrscheinlich in der Schule gesagt, dass Fehler schlecht sind. Aber wenn du eine neue Sprache lernst, sind Fehler gut. Es gibt nur zwei Arten von Fehlern—die ers...
...
**German:** Wenn du keine Fehler machst, bedeutet das, dass es zu einfach für dich ist—vielleicht solltest du versuchen, mit Überspringen vorzuspringen!
...
**German:** Denk daran, dass du in der Pause laut sprechen musst—auch wenn du nicht den ganzen Satz sagen kannst, sag so viele Wörter wie du kannst.
...
**German:** Es ist wichtig, mit Sprache zu spielen, es spaßig zu machen, also nimm dich selbst nicht zu ernst und versuch zu lachen, wenn etwas schiefgeht—je lustiger es sich anfühlt, desto schneller wirst du vorankommen.
