# Translate encouragement messages to French
...
2. **"your new language"** — translate naturally as the equivalent phrase in French (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "French" or "English".
...
6. **"press-ups"** — use whatever term is natural in French (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural French is more important than literal accuracy
...
**French:**
Alors, ce que tu fais ici est un travail très difficile pour le cerveau—c'est comme ça qu'il te fait apprendre si vite—donc de temps en temps, je vais te donner une petite pause et te dire quelques choses sur ce voyage qui t'aideront à réussir. Tout d'abord, savais-tu que ton cerveau possède environ...
...
**French:**
Maintenant, je t'ai demandé de faire des erreurs, et si tu es comme la plupart des gens, tu n'aimes pas faire d'erreurs. On t'a probablement dit à l'école que les erreurs sont mauvaises. Mais quand tu apprends une nouvelle langue, les erreurs sont bonnes. Il n'y a que deux types d'erreurs—les premiè...
...
**French:** Si tu ne fais pas d'erreurs, ça veut dire que c'est trop facile pour toi—peut-être devrais-tu essayer Passer pour avancer !
...
**French:** Souviens-toi que tu dois parler à voix haute dans la pause—même si tu ne peux pas dire toute la phrase, dis autant de mots que tu peux.
...
**French:** C'est important de jouer avec la langue, de rendre ça amusant, alors ne te prends pas trop au sérieux, et essaie de rire quand quelque chose ne va pas—plus c'est drôle, plus tu iras vite.
