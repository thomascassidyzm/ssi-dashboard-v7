# Translate encouragement messages to Czech
...
2. **"your new language"** — translate naturally as the equivalent phrase in Czech (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Czech" or "English".
...
6. **"press-ups"** — use whatever term is natural in Czech (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Czech is more important than literal accuracy
...
**Czech:**
Takže to, co tady děláš, je pro mozek velmi těžká práce — tak tě nutí učit se tak rychle — takže ti občas dám malou pauzu a řeknu ti pár věcí o této cestě, které ti pomohou k úspěchu. Za prvé, věděl jsi, že tvůj mozek má asi 100 miliard neuronů? To je přibližně tolik neuronů, kolik je hvězd v naší g...
...
**Czech:**
Takže jsem tě žádal, abys dělal chyby, a pokud jsi jako většina lidí, nerád děláš chyby. Pravděpodobně ti ve škole říkali, že chyby jsou špatné. Ale když se učíš nový jazyk, chyby jsou dobré. Jsou jen dva druhy chyb — první jsou ty, kterých si nevšimneš, což není problém, protože si jich nevšimneš. ...
...
**Czech:** Pokud neděláš chyby, znamená to, že je to pro tebe příliš snadné — možná bys měl zkusit Přeskoč a posunout se dál!
...
**Czech:** Pamatuj, že musíš v pauze mluvit nahlas — i když nemůžeš říct celou větu, řekni tolik slov, kolik zvládneš.
...
**Czech:** Je důležité si s jazykem hrát, aby to byla zábava, takže se neber příliš vážně a snaž se smát, když něco nejde — čím víc zábavy ti to přijde, tím rychleji to půjde.
