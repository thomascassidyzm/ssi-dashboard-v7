# Translate encouragement messages to Bulgarian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Bulgarian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Bulgarian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Bulgarian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Bulgarian is more important than literal accuracy
...
**Bulgarian:**
Така че това, което правиш тук, е много трудна работа за мозъка — така те кара да учиш толкова бързо — затова от време на време ще ти давам малка почивка и ще ти казвам няколко неща за това пътуване, които ще ти помогнат да успееш. Първо, знаеше ли, че мозъкът ти има около 100 милиарда неврона? Това...
...
**Bulgarian:**
Така че те помолих да правиш грешки, и ако си като повечето хора, не обичаш да правиш грешки. Вероятно са ти казвали в училище, че грешките са лоши. Но когато учиш нов език, грешките са добри. Има само два вида грешки — първите са тези, които не забелязваш, което не е проблем, защото не ги забелязва...
...
**Bulgarian:** Ако не правиш грешки, това означава, че е твърде лесно за теб — може би трябва да опиташ Пропусни и да продължиш напред!
...
**Bulgarian:** Помни, че трябва да говориш на глас в паузата — дори и да не можеш да кажеш цялото изречение, кажи колкото думи можеш.
...
**Bulgarian:** Важно е да си играеш с езика, за да е забавно, така че не се приемай твърде насериозно и се опитвай да се смееш, когато нещо не се получава — колкото по-забавно ти се струва, толкова по-бързо ще върви.
