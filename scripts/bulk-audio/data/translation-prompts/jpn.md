# Translate encouragement messages to Japanese
...
2. **"your new language"** — translate naturally as the equivalent phrase in Japanese (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Japanese" or "English".
...
6. **"press-ups"** — use whatever term is natural in Japanese (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Japanese is more important than literal accuracy
...
**Japanese:**
さて、今あなたがしていることは脳にとって非常にハードな作業です。だからこそ、こんなに早く学べるんです。時々、少し休憩を取って、この旅で成功するために役立つことをお話しします。まず、あなたの脳には約1000億のニューロンがあることを知っていましたか？それは私たちの銀河系の星の数とほぼ同じです。学校で何を言われたとしても、あなたの脳は本当に素晴らしいんです。だから言語を学ぶ脳の能力を信じてください。全ての脳は、正しいトレーニングを受ければ、学習がとても上手なんです。そして私はあなたに、まさに正しいトレーニングを提供します。さあ、続けましょう。ああ、そして時々間違いをしても大丈夫です。実は、それは良...
...
**Japanese:**
さて、私は間違いをするようにお願いしてきましたが、もしあなたがほとんどの人と同じなら、間違いをするのは好きではないでしょう。学校ではおそらく間違いは悪いと言われたでしょう。でも新しい言語を学んでいるとき、間違いは良いことなんです。間違いは2種類しかありません。1つ目は気づかない間違いで、気づかないから問題ではありません。2つ目は、あなたが言ったことが聞いたお手本と違うと気づく間違いです。それに気づくためには、脳はあなたが言ったことをお手本と比較して、違いを識別しなければなりません。そしてそのプロセスには別の言葉があります。脳が変化するために必要な入力を得るとき、私たちはそれを学習と呼びます。間...
...
**Japanese:** 間違いをしていないなら、それはあなたにとって簡単すぎるということです。スキップで先に進んでみましょう！
...
**Japanese:** 間の時間に声に出して話す必要があることを忘れないでください。文全体が言えなくても、できるだけ多くの単語を言ってください。
...
**Japanese:** 言葉で遊ぶこと、楽しむことが大切です。だから自分を真剣に取りすぎないで、何かうまくいかないときは笑ってみてください。楽しければ楽しいほど、早く上達しますよ。
