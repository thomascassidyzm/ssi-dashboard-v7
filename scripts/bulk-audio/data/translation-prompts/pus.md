# Translate encouragement messages to Pashto
...
2. **"your new language"** — translate naturally as the equivalent phrase in Pashto (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Pashto" or "English".
...
6. **"press-ups"** — use whatever term is natural in Pashto (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Pashto is more important than literal accuracy
...
**Pashto:**
اوس، هغه څه چې تاسو دلته کوئ د مغز لپاره ډیره سخته کار ده—په همدې توګه تاسو ته دومره ژر زده کوي—نو هر کله به، زه تاسو ته یو کوچنی وقفه درکوم او تاسو ته به د دې سفر په اړه ځینې شیان ووایم چې به تاسو سره د بریالیتوب لپاره مرسته وکړي. لومړی، ایا پوهیدلئ چې ستاسو مغز شاوخوا 100 میلیارده نیورونونه لري؟ د...
...
**Pashto:**
اوس، ما تاسو ته ووایل چې غلطۍ وکړئ، او که تاسو د ډیرو خلکو په شان یاست، تاسو د غلطیو کول نه خوښوئ. شاید تاسو ته په ښوونځي کې ویل شوي وي چې غلطۍ بدې دي. مګر کله چې تاسو نوې ژبه زده کوئ، غلطۍ ښې دي. یوازې دوه ډوله غلطۍ شته—لومړی هغه دي چې تاسو یې نه پام کوئ، کوم چې ستونزه نه ده ځکه چې تاسو یې نه پام ک...
...
**Pashto:** که تاسو غلطۍ نه کوئ، دا پدې مانا ده چې ستاسو لپاره ډیره اسانه ده—شاید باید هڅه وکړئ چې مخکې پریږدئ وکړئ!
...
**Pashto:** په یاد ولرئ چې تاسو باید په وقفه کې په لوړ غږ خبرې وکړئ—حتی که نشئ کولی ټوله جمله ووایاست، هرڅومره ټکي چې کولی شئ ووایاست.
...
**Pashto:** دا مهمه ده چې له ژبې سره لوبې وکړئ، ساتیره یې کړئ، نو ځان ډیر جدي مه نیسئ، او هڅه وکړئ چې خندا وکړئ کله چې کوم څه غلط شي—هرڅومره چې مسخره احساس کوي، هغومره به ژر لاړ شئ.
