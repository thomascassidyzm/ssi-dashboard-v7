# Translate encouragement messages to Arabic
...
2. **"your new language"** — translate naturally as the equivalent phrase in Arabic (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Arabic" or "English".
...
6. **"press-ups"** — use whatever term is natural in Arabic (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Arabic is more important than literal accuracy
...
**Arabic:**
الآن، ما تفعله هنا هو عمل شاق جداً للدماغ—هذا ما يجعلك تتعلم بسرعة—لذا بين الحين والآخر، سأعطيك استراحة صغيرة وأخبرك ببعض الأشياء عن هذه الرحلة التي ستساعدك على النجاح. أولاً، هل كنت تعلم أن دماغك يحتوي على حوالي مئة مليار خلية عصبية؟ هذا تقريباً نفس عدد النجوم في مجرتنا. مهما قيل لك في المدرسة، دما...
...
**Arabic:**
الآن، لقد طلبت منك أن ترتكب أخطاء، وإذا كنت مثل معظم الناس، فأنت لا تحب ارتكاب الأخطاء. ربما قيل لك في المدرسة أن الأخطاء سيئة. لكن عندما تتعلم لغة جديدة، الأخطاء جيدة. هناك نوعان فقط من الأخطاء—الأول هو تلك التي لا تلاحظها، وهي ليست مشكلة لأنك لا تلاحظها. الثاني هو تلك التي تلاحظ فيها أن ما قلته كا...
...
**Arabic:** إذا لم تكن ترتكب أخطاء، فهذا يعني أن الأمر سهل جداً بالنسبة لك—ربما يجب أن تجرب تخطي للتقدم!
...
**Arabic:** تذكر أنك تحتاج أن تتحدث بصوت مسموع في الفجوة—حتى لو لم تستطع قول الجملة كاملة، قل أكبر عدد ممكن من الكلمات.
...
**Arabic:** من المهم أن تلعب مع اللغة، وأن تجعلها ممتعة، لذا لا تأخذ نفسك بجدية مبالغ فيها، وحاول أن تضحك عندما يحدث أي خطأ—كلما شعرت أن الأمر مضحك، كلما تقدمت أسرع.
