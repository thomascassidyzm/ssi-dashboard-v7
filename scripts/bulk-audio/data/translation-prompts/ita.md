# Translate encouragement messages to Italian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Italian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Italian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Italian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Italian is more important than literal accuracy
...
**Italian:**
Allora, quello che stai facendo qui è un lavoro molto duro per il cervello—è così che ti fa imparare così velocemente—quindi ogni tanto ti darò una piccola pausa e ti dirò alcune cose su questo viaggio che ti aiuteranno ad avere successo. Prima di tutto, sapevi che il tuo cervello ha circa 100 milia...
...
**Italian:**
Ora, ti ho chiesto di fare errori, e se sei come la maggior parte delle persone, non ti piace fare errori. Probabilmente ti hanno detto a scuola che gli errori sono sbagliati. Ma quando stai imparando una nuova lingua, gli errori sono buoni. Ci sono solo due tipi di errori—i primi sono quelli che no...
...
**Italian:** Se non stai facendo errori, significa che è troppo facile per te—forse dovresti provare a usare Salta per andare avanti!
...
**Italian:** Ricorda che devi parlare ad alta voce nella pausa—anche se non riesci a dire l'intera frase, di' quante più parole puoi.
...
**Italian:** È importante giocare con la lingua, renderla divertente, quindi non prenderti troppo sul serio e cerca di ridere quando qualcosa va storto—più ti sembra divertente, più velocemente andrai avanti.
