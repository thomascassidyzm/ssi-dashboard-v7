# Translate encouragement messages to Spanish
...
2. **"your new language"** — translate naturally as the equivalent phrase in Spanish (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Spanish" or "English".
...
6. **"press-ups"** — use whatever term is natural in Spanish (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Spanish is more important than literal accuracy
...
**Spanish:**
Ahora bien, lo que estás haciendo aquí es un trabajo muy duro para el cerebro—así es como te hace aprender tan rápido—así que de vez en cuando, voy a darte un pequeño descanso y contarte algunas cosas sobre este viaje que te ayudarán a tener éxito. Primero, ¿sabías que tu cerebro tiene unos 100 mil ...
...
**Spanish:**
Ahora, te he estado pidiendo que cometas errores, y si eres como la mayoría de la gente, no te gusta cometer errores. Probablemente te dijeron en la escuela que los errores son malos. Pero cuando estás aprendiendo un nuevo idioma, los errores son buenos. Solo hay dos tipos de errores—los primeros so...
...
**Spanish:** Si no estás cometiendo errores, significa que es demasiado fácil para ti—¡quizás deberías intentar Saltar para avanzar!
...
**Spanish:** Recuerda que necesitas hablar en voz alta en la pausa—aunque no puedas decir toda la frase, di tantas palabras como puedas.
...
**Spanish:** Es importante jugar con el idioma, hacerlo divertido, así que no te tomes demasiado en serio, e intenta reírte cuando algo salga mal—cuanto más gracioso te parezca, más rápido avanzarás.
