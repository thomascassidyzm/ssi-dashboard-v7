# Translate encouragement messages to Hungarian
...
2. **"your new language"** — translate naturally as the equivalent phrase in Hungarian (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Hungarian" or "English".
...
6. **"press-ups"** — use whatever term is natural in Hungarian (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Hungarian is more important than literal accuracy
...
**Hungarian:**
Szóval amit itt csinálsz, az nagyon kemény munka az agynak — így kényszerít ilyen gyorsan tanulni — úgyhogy időnként adok egy kis szünetet és mondok néhány dolgot erről az útról, amik segítenek a sikerben. Először is, tudtad, hogy az agyadban körülbelül 100 milliárd neuron van? Ez nagyjából annyi ne...
...
**Hungarian:**
Szóval arra kértelek, hogy hibázz, és ha olyan vagy, mint a legtöbb ember, nem szeretsz hibázni. Valószínűleg azt mondták neked az iskolában, hogy a hibák rosszak. De amikor új nyelvet tanulsz, a hibák jók. Csak kétféle hiba van — az elsők azok, amiket nem veszel észre, ami nem probléma, mert nem ve...
...
**Hungarian:** Ha nem csinálsz hibákat, az azt jelenti, hogy túl könnyű neked — talán próbáld meg a Ugorj-et és lépj tovább!
...
**Hungarian:** Ne feledd, hogy a szünetben hangosan kell beszélned — még ha nem is tudod elmondani az egész mondatot, mondj annyi szót, amennyit tudsz.
...
**Hungarian:** Fontos játszani a nyelvvel, hogy szórakoztató legyen, szóval ne vedd túl komolyan magad, és próbálj nevetni, ha valami nem megy — minél szórakoztatóbbnak találod, annál gyorsabban fog menni.
