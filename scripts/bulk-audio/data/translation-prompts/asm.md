# Translate encouragement messages to Assamese
...
2. **"your new language"** — translate naturally as the equivalent phrase in Assamese (e.g., "tu nueva lengua" in Spanish). Do NOT use the word "Assamese" or "English".
...
6. **"press-ups"** — use whatever term is natural in Assamese (push-ups, etc.)
7. **Preserve the meaning and encouragement, not word-for-word** — natural Assamese is more important than literal accuracy
...
**Assamese:**
এতিয়া, তুমি ইয়াত যি কৰি আছা সেয়া মগজুৰ বাবে অতি কঠিন কাম—এইদৰেই ই তোমাক ইমান সোনকালে শিকাই—গতিকে মাজে মাজে, মই তোমাক অলপ বিৰতি দিম আৰু এই যাত্ৰাৰ বিষয়ে কিছুমান কথা ক'ম যিয়ে তোমাক সফল হোৱাত সহায় কৰিব। প্ৰথমতে, তুমি জানিছিলানে যে তোমাৰ মগজুত প্ৰায় ১০০ বিলিয়ন নিউৰন আছে? সেয়া আমাৰ আকাশগংগাত যিম...
...
**Assamese:**
এতিয়া, মই তোমাক ভুল কৰিবলৈ কৈছোঁ, আৰু যদি তুমি বেছিভাগ মানুহৰ দৰে, তুমি ভুল কৰি ভাল নাপাবা। তোমাক সম্ভৱতঃ স্কুলত কোৱা হৈছিল যে ভুল বেয়া। কিন্তু যেতিয়া তুমি নতুন ভাষা শিকি আছা, ভুল ভাল। মাত্ৰ দুই ধৰণৰ ভুল আছে—প্ৰথম হ'ল সেইবোৰ যিবোৰ তুমি লক্ষ্য নকৰা, যিবোৰ সমস্যা নহয় কাৰণ তুমি সিহঁতক লক্ষ্য নকৰা। ...
...
**Assamese:** যদি তুমি ভুল কৰা নাই, তাৰ মানে ই তোমাৰ বাবে বেছি সহজ—হয়তো তুমি আগলৈ এৰি যাওক কৰাৰ চেষ্টা কৰিব লাগে!
...
**Assamese:** মনত ৰাখিবা যে তুমি ফাঁকত ডাঙৰকৈ কথা ক'ব লাগে—সম্পূৰ্ণ বাক্যটো ক'ব নোৱাৰিলেও, যিমান শব্দ পাৰা কোৱা।
...
**Assamese:** ভাষাৰ লগত খেলা কৰাটো গুৰুত্বপূৰ্ণ, ইয়াক মজাদাৰ কৰা, গতিকে নিজকে বেছি গুৰুত্বৰে নল'বা, আৰু কিবা ভুল হ'লে হাঁহিবলৈ চেষ্টা কৰা—যিমান মজা লাগে, সিমান খৰকৈ আগবাঢ়িবা।
