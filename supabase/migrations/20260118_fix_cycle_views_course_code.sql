-- ============================================================================
-- FIX CYCLE VIEWS - Use course_code instead of code
--
-- The courses table was updated to use course_code instead of code
-- to match the naming convention of all other tables.
-- ============================================================================
...
-- COMMENTS
-- ============================================================================
COMMENT ON VIEW lego_cycles IS 'v13: Self-contained LEGO items with audio from course_audio. Fixed to use courses.course_code.';
COMMENT ON VIEW practice_cycles IS 'v13: Practice phrases with duration_ms for ordering. Fixed to use courses.course_code.';
COMMENT ON VIEW seed_cycles IS 'v13: Seed items with audio from course_audio. Fixed to use courses.course_code.';
