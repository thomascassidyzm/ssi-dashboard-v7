...
s0231.legos["S0230L01"] = {
  ...
  practice_phrases: [
    ...
    ["I know someone who wanted to speak with you", "Conozco a alguien que quería hablar contigo", null, 6],
...
s0232.legos["S0232L02"] = {
  ...
  practice_phrases: [
    ...
    ["I know an old woman who wanted to ask for help", "Conozco a una mujer vieja que quería pedir ayuda", null, 7]
  ],
  phrase_distribution: { really_short_1_2: 2, quite_short_3: 1, longer_4_5: 2, long_6_plus: 5 }
};
...
s0232.legos["S0232L04"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to be able to remember the answer", "Quería poder recordar la respuesta", null, 6],
...
s0233.legos["S0233L02"] = {
  ...
  practice_phrases: [
    ...
    ["I know a young woman who wanted to help", "Conozco a una mujer joven que quería ayudar", null, 6],
...
s0233.legos["S0233L05"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to speak with your sister", "Quería hablar con tu hermana", null, 4],
    ["I know a young woman who knows your sister.", "Conozco a una mujer joven que conoce a tu hermana.", null, 5],
...
s0234.legos["S0234L01"] = {
  ...
  practice_phrases: [
    ...
    ["I met someone who works with your brother", "Conocí a alguien que trabaja con tu hermano", null, 6]
  ],
  phrase_distribution: { really_short_1_2: 2, quite_short_3: 1, longer_4_5: 3, long_6_plus: 4 }
};
...
s0234.legos["S0234L07"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to speak with your brother", "Quería hablar con tu hermano", null, 4],
    ["I met someone last night who works with your brother.", "Conocí a alguien anoche que trabaja con tu hermano.", null, 6],
    ["I know someone who wanted to speak with your brother", "Conozco a alguien que quería hablar con tu hermano", null, 7]
  ],
  phrase_distribution: { really_short_1_2: 2, quite_short_3: 2, longer_4_5: 2, long_6_plus: 4 },
  full_seed_included: "YES"
};
...
s0235.legos["S0235L07"] = {
  ...
  practice_phrases: [
    ...
    ["I met someone who wanted to tell you something", "Conocí a alguien que quería decirte algo", null, 7],
    ["I met someone who said that he wanted to tell you something.", "Conocí a alguien que dijo que quería decirte algo.", null, 9],
    ["I wanted to be able to tell you", "Quería poder decirte", null, 4]
  ],
  phrase_distribution: { really_short_1_2: 2, quite_short_3: 2, longer_4_5: 3, long_6_plus: 3 },
  full_seed_included: "YES"
};
...
s0236.legos["S0236L06"] = {
  ...
  practice_phrases: [
    ...
    ["I met someone last night who was going to try to help", "Conocí a alguien anoche que iba a intentar ayudar", null, 7],
    ["I met someone who said that she was going to try to help", "Conocí a alguien que dijo que iba a intentar ayudar", null, 8]
  ],
...
s0237.legos["S0237L01"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to be able to help", "Quería poder ayudar", null, 4],
    ["I met someone who wanted to help", "Conocí a alguien que quería ayudar", null, 6],
    ["I know someone who wanted to speak with you", "Conozco a alguien que quería hablar contigo", null, 6],
...
s0237.legos["S0237L02"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to tell you yesterday", "Quería decirte ayer", null, 3],
    ["He wanted me to tell you before the weekend", "Quería que te dijera antes del fin de semana", null, 7],
    ["I wanted to tell you before I had to go", "Quería decirte antes de que tenga que ir", null, 8]
  ],
...
s0237.legos["S0237L03"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to speak with you before the weekend", "Quería hablar contigo antes del fin de semana", null, 6],
    ["I wanted to speak before the weekend", "Quería hablar antes del fin de semana", null, 4],
    ...
    ["I wanted to ask for help before the weekend", "Quería pedir ayuda antes del fin de semana", null, 6]
  ],
...
s0238.legos["S0238L02"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted you to help me yesterday", "Quería que me ayudaras ayer", null, 5],
    ...
    ["I wanted you to help me before the weekend", "Quería que me ayudaras antes del fin de semana", null, 7],
    ["I wanted you to help me before I had to go", "Quería que me ayudaras antes de que tenga que ir", null, 9]
  ],
...
s0239.legos["S0239L01"] = {
  ...
  practice_phrases: [
    ...
    ["My mother wanted to help before the weekend", "Mi madre quería ayudar antes del fin de semana", null, 7],
    ...
    ["I met someone who knows my mother", "Conocí a alguien que conoce a mi madre", null, 6]
  ],
...
s0239.legos["S0239L02"] = {
  ...
  practice_phrases: [
    ...
    ["I know someone who likes to speak Spanish", "Conozco a alguien que le gusta hablar español", null, 7]
  ],
  phrase_distribution: { really_short_1_2: 1, quite_short_3: 3, longer_4_5: 2, long_6_plus: 4 }
};
...
s0239.legos["S0035L01"] = {
  ...
  practice_phrases: [
    ...
    ["I wanted to be able to read in Spanish", "Quería poder leer en español", null, 6],
    ["My mother wanted to be able to read in Spanish", "Mi madre quería poder leer en español", null, 7],
    ["I met someone who likes to read", "Conocí a alguien que le gusta leer", null, 6]
  ],
...
s0240.legos["S0240L01"] = {
  ...
  practice_phrases: [
    ...
    ["My father wanted to help before the weekend", "Mi padre quería ayudar antes del fin de semana", null, 7],
    ...
    ["I met someone who knows my father", "Conocí a alguien que conoce a mi padre", null, 6]
  ],
  phrase_distribution: { really_short_1_2: 1, quite_short_3: 2, longer_4_5: 2, long_6_plus: 5 }
};
...
s0240.legos["S0240L02"] = {
  ...
  practice_phrases: [
    ...
    ["I know someone who doesn't like to speak Spanish", "Conozco a alguien que no le gusta hablar español", null, 8]
  ],
...
s0240.legos["S0240L03"] = {
  ...
  practice_phrases: [
    ...
    ["I don't want to stop talking", "No quiero dejar de hablar", null, 5],
    ["I wanted to stop talking before the weekend", "Quería dejar de hablar antes del fin de semana", null, 7],
    ["I know someone who doesn't like to stop talking", "Conozco a alguien que no le gusta dejar de hablar", null, 8]
  ],
...
console.log(`\nRun 'node validate_gate_compliance.cjs' to validate GATE compliance.`);
