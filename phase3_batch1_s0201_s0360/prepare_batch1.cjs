#!/usr/bin/env node
/**
 * Prepare Batch 1: S0201-S0360 for parallel LEGO extraction
 * Creates 8 input files of 20 seeds each + cumulative registry
 */

const fs = require('fs');
const path = require('path');

console.log('🔧 Preparing Batch 1: S0201-S0360\n');
...
// Build cumulative registry (S0001-S0200)
console.log('📚 Building cumulative registry (S0001-S0200)...\n');
...
const registryFile = path.join(__dirname, 'registry', 'lego_registry_s0001_s0200.json');
...
console.log(`  Total: 551 LEGOs\n`);

console.log('='.repeat(60));
console.log('BATCH 1 PREPARATION COMPLETE');
console.log('='.repeat(60));
