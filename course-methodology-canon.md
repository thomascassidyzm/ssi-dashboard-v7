...
**Fourteen of them left this list on 2026-09-08**, when a harvest of Kai's own words found that he had already ruled on them — most in one sitting on 2026-08-27, when he walked this list clash by clash and answered it. Each keeps a one-line pointer below saying where its rule now lives; nothing was deleted silently. **C22 closed fully on 2026-09-08** when Kai ruled the practice-coverage ladder (**P19**). **C21 closed fully on 2026-09-08** when Kai ruled that a spoken-versus-displayed mismatch is usually a stale clip left by an earlier text fix (**A22**, **A23**). Two more (C17, C20) are **partly** ruled: what his words settle has been written into the rules, and what is left is tightened to the residue and stays here. Four (C11, C12, C18, C19) he has never spoken to, and they are untouched — **a pattern in his other rulings is not a ruling.**
...
**C24 is RULED and has left this list.** *(Kai, 2026-09-08.)* The clash was posed as a string question — do inflections of a taught word count as taught? — and his answer moves the known-side test off strings altogether. **The test is one question: will the learner reach for the correct target word as the first thing?** "It doesn't have to match exactly in the known language, if there is a clear connection between the two - will the learner think of the correct target word as the first thing, even if it isn't exactly the same thing they've been taught?" A mutated known-side form passes; "remembering" against a taught "remember" passes. **The sharpest part is the failing side, and it is not about form at all:** a known form the learner has no route to FAILS **even when the target word is identical** — Welsh *dysgu* is both "to learn" and "to teach", and a learner taught "to learn" cannot be prompted with "to teach", because "there is no automatic connection between the two for an English speaker". **Identity in the target does not license a known-side prompt.** The target side is a different and much stricter question — exact matches on the whole, with narrow barely-audible exceptions. The known-side rule now lives at **K6**, refined rather than duplicated; the target-side half at **K8**; **K21**'s exact-surface-form standard is the TARGET side's, not the known side's test. **He had answered it before** — "I'm sure I have answered this before" — and he had: **K6** has carried the substance since 2026-08-17 and its 2026-08-28 bound ("as long as the learner will easily connect the two concepts without having to think about it") is this same test in earlier words. **One honest note, and it is why nothing was changed in code:** Tom's **K21** was stated with *known-side English* examples (*I drink / he drinks / is drinking*), and on those examples the two rulings reach different answers. The gate does what Tom ruled — `validation.cjs` `stemKnownGloss` is an exact-form normaliser with "NO inflection allowance" — and **changing it is Tom's call, not this document's.** Recorded in GAPS.
...
**C21 is RULED and has left this list.** *(Kai, 2026-09-08.)* When a clip and its displayed text disagree, the mismatch is **usually the fingerprint of an earlier text fix whose audio was never nulled and regenerated** — "usually when they don't match it's due to a past fix, that forgot to null and regenerate the audio. That means that more often than not, the text is correct. However it should always be investigated." So the text is normally the newer and correct artefact and the clip is stale, the default repair runs **audio-to-match-text and never text-to-match-clip**, and "usually" is deliberate: it is a strong default, and **every mismatch is still investigated individually** rather than bulk-regenerated. The rule now lives at **A22**, and the upstream cause he named — a text fix that skips nulling and regenerating its audio manufactures the defect — is stated as a rule of its own at **A23**. The half already settled on 2026-08-18/24 stays at **A21**. **One honest note on scope:** his ruling says what to do with a mismatch and that every one must be investigated; he did not speak to whether an automated spoken-versus-displayed check should be built, and none is mandated by it — scan-course still reads text tables and never joins `course_audio`.
...
**C22 is RULED and has left this list.** *(Kai, 2026-09-08.)* Practice coverage is a **ladder**, and emptiness at the bottom of it is a **flag**, not a blocker: every new LEGO should have its own phrases, never at the cost of another rule; where the available LEGOs genuinely cannot produce valid ones the flag's first job is to ask whether the LEGOs are cut wrong; empty is the absolute last resort; and an empty debut obliges catch-up drilling at the next few LEGOs. Since he permits empty as a last resort, a check cannot fail a build for it — Checks 16/17 stay informational, and what they need to learn is to tell *empty-and-followed-by-drilling* from *empty-and-nothing-follows*. The rule now lives at **P19**, refining **P10**; **P17** and **P18** are unchanged.

**C25 is RULED and has left this list.** *(Kai, 2026-09-01 and 2026-09-08.)* The clash asked whether familiarity alone licenses `is_new:false`. **He answered with a different ground: SEPARABILITY, decided per language pair.** "It depends on the pairing. If 'I'm going to' can stand on its own in both languages, and there is no weird conjugation, mood etc funny business (even stuff like it clashes with a future lego), they should be introduced separately and be introduced just once. If there's anything in there that means we should introduce 'I'm going to' together with the verb, then we introduce it together with the verb again." So where the frame is separable it is a LEGO of its own, taught **once**, and its later recurrences are not new; where it is not separable, every occurrence is a genuine debut and keeps it. That is not familiarity, and **L17** is refined rather than overruled — it now names separability as the ground it did not recognise. **He also ruled the target-side half on 2026-09-08:** word-order movement is not by itself a reason to fuse — where grammar splits a chunk's words apart the chunk stays one chunk and the answer is **more drilling**. **He bounded that in the same breath and the bound is part of the ruling:** "We still don't want ellipses in the lego… Instead of ellipses we should just make a bigger lego. If the first part and last part can't stand on their own or together with nothing between them, we just need to include more of the seed sentence words in the lego to make it work." So the drilling answer is **only** for a chunk that is real and sayable when TAUGHT and gets split later; a chunk that needs a gap notated is not a chunk, and the fix is to **GROW IT** (**L2**, **L22**). **The ban on invented notation at L22/K11/L19 is untouched and this carves no exception out of it.** The rule now lives at **L25**, with the debut half at **L17**. **His hedge is kept:** "Would need more context to answer properly, but I believe…" — stated belief, not a settled universal, and a specific case may still be brought back to him. **Two live cases were ruled at the same time and are closed, not open defects:** the Arabic one-future-two-glosses shape ("this is fine!") and the Italian one, which was reported to him as a defect and is not one — **many known prompts to one target string is the allowed direction** (**K3**, **K2**). Both are written up at **L25**.
...
He said the same on 2026-08-19 about the missing-question-mark rule and about overruling the methodology canon: "it kind of affects the course generation process widely which is something Tom should have a say in and clarity about. We might disagree, who knows." · **This is why the ten-location sweeps behind clashes C1 and C2 have still not been run**: the ruling that decides their *content* is Kai's, and the authority to edit those *files* is Tom's · Keeping **this canon** current is not covered — Kai has asked for that directly (see "How to add to this").
...
**R0.16 — Every phrase pair in a course gets a read-through for grammatical wrongness and unnaturalness, judged against the LEGOs the learner holds.** · **HARD (that the read happens), SOFT (who does it)** · **Kai, 2026-08-24, 2026-08-25 and 2026-09-08 — partly ruling clash C20** · This is the defect humans name first and the one the machine is told not to look at; a learner quit over Japanese grammar errors.
...
**L17 — Suppress a debut (`is_new:false`) only for a pure same-meaning restatement, or where the chunk is a SEPARABLE frame already taught once in its own right.** · **HARD** · `ralph-methodology.md:57`; **second clause: Kai, 2026-09-01 and 2026-09-08, closing clash C25** · The lever is minor by design — ~15 of ~1,100 rounds in the zho audit · Distinct words, idiomatic chunks, overlap-ladder rungs and deliberate nuance re-debuts all keep their debut.

**What C25 asked and what he answered.** The clash asked whether *familiarity* — enough drilling — is a ground for suppressing a debut. **It is not; separability is.** Where a frame stands on its own in both languages (**L25**), it is introduced separately and **"introduced just once"**, so its later recurrences carry no new teaching and `is_new:false` is correct. Where it is not separable, it is introduced together with the verb **again**, and each of those is a real debut · **His 2026-09-01 words are kept as he said them, hedge and all:** "After the first couple legos with 'I'm going to x' we can just start treating it as taught (is new false)." *A couple*, not one — he did not name a number and none is invented here · **This does not license suppressing a debut for a DIFFERENT surface form.** A form the learner has not been shown is new however familiar the pattern feels — **K21**, and GAPS item 17 where he says it in his own words about *amigo* / *mis amigos*.
...
**L25 — Whether a frame is SEPARABLE is decided PER LANGUAGE PAIR; and where grammar splits a chunk's words apart, the chunk STAYS ONE CHUNK and the answer is more drilling — but ONLY where it is a real chunk. NEVER an ellipsis: if the two parts cannot stand alone or stand together with nothing between them, GROW THE LEGO.** · **HARD (that the question is per-pairing; that movement alone is not a reason to fuse), SOFT (the answer for any given pair, and how much drilling is enough)** · **Kai, 2026-09-01 and 2026-09-08, closing clash C25** · An English frame is not a fact about the course — the same English frame is a bound suffix in one target language and a free word in another, so a rule written from the English side is wrong half the time.

> "It depends on the pairing. If 'I'm going to' can stand on its own in both languages, and there is no weird conjugation, mood etc funny business (even stuff like it clashes with a future lego), **they should be introduced separately and be introduced just once**. If there's anything in there that means we should introduce 'I'm going to' together with the verb, then **we introduce it together with the verb again**." — Kai, 2026-09-01

**The evidence that it really is per-pairing.** The same English frame *want to* is a **bound suffix in Japanese** — 話したい, not separable, so its many debuts alongside their verbs are **correct** — and a **free modal in Chinese** — 想, separable, so it is introduced once. **One English frame, opposite answers.** Never carry a separability decision from one pair to another (**K12**, **R0.7**).

**The two branches:**
1. **Separable** — it stands on its own in **both** languages, with no conjugation, mood or other funny business, and no clash with an existing or coming LEGO (his own parenthesis: *"even stuff like it clashes with a future lego"*). Then it is its own LEGO, **introduced once**, and later occurrences are not new (**L17**).
2. **Not separable** — anything in it means the frame has to arrive with the verb. Then **it is introduced together with the verb again**, each time, and each of those is a genuine debut. That is not redundancy and must not be swept as one.

**Word-order movement is NOT by itself a reason to fuse.** *(Kai, 2026-09-08, on the German borderline case — and it generalises beyond German.)*

> "Would need more context to answer properly, but **I believe we can introduce a lego, and then if grammatically other legos would go in between the lego words, it just needs a lot more drilling, a lot more practice phrases in the lego itself and future legos, to make sure the learner gets used to the weirdness**." — Kai, 2026-09-08

Where the grammar splits a chunk's words apart, **the chunk stays one chunk** and the remedy is **drilling**: more practice phrases in its own basket **and in later ones**, until the learner is used to the weirdness · **His hedge is his and is kept:** *"Would need more context to answer properly, but I believe…"* — this is his stated belief, not a settled universal, and **a specific case may still be brought back to him** · This is **K8**'s split clause reaching the target side as a chunking rule: K8 says a word may be inserted between a multi-word LEGO's words, and this says that when it routinely is, you drill rather than re-cut · Pairs with **L21** ("sometimes the answer is to add more, not less"), **P12** (front-load the drilling, then taper) and **P19** (coverage never at the cost of another rule).

**THE BOUNDARY ON THIS RULE, AND IT IS PART OF THE RULING — NOT A FOOTNOTE.** *(Kai, 2026-09-08, qualifying the drilling answer in the same breath as giving it.)*

> "**We still don't want ellipses in the lego**, by the way, I just mean this **for legos that can be taught as a chunk that then gets separated in its phrases**. Instead of ellipses **we should just make a bigger lego**. If the first part and last part can't stand on their own or together with nothing between them, **we just need to include more of the seed sentence words in the lego to make it work**." — Kai, 2026-09-08

**What this rule applies to:** a chunk that is a **real, sayable, contiguous unit at the moment it is TAUGHT**, and which grammar later splits apart inside its practice phrases — the German *werde … warten* shape. That chunk stays one chunk, is taught whole, and is drilled hard (**K8**'s split clause is exactly the permission that makes this legal).

**What it does NOT apply to and NEVER licenses:** a chunk **stored with a gap, ellipsis, tilde, bracket or placeholder in it**. The standing ban on invented notation is **unchanged and absolute** — it is stated at **L22** ("Ruled out explicitly… Kai on that option: *yeah, this one is a no-go*"), and reached from two other directions at **K11** (no parenthetical tags, ever) and **L19**. **This entry carves no exception out of any of them.** A lesson the learner cannot say aloud is not a LEGO.

**THE TEST for which of the two you are holding — one question:** *can the first part and the last part stand on their own, or stand together with nothing between them?*
- **YES** — it is a real chunk that grammar splits later. Teach it whole; drill it hard, in its own basket and in later ones (above).
- **NO** — **it is not a chunk at all, and no amount of drilling makes it one.** The fix is to **GROW IT**: "we just need to include more of the seed sentence words in the lego to make it work." Never notate the gap; **make a bigger LEGO.**

Growing is the standing answer here, not a special move invented for this case: **L2** — where one side of the pair cannot be broken down, the chunk grows on **both** sides rather than being split — and **L22**, where the growth is taken from **the seed's own sentence** ("Grow it to whatever is in the seed. What does the seed say?") and expands both sides of the LEGO. **L22**'s two 2026-09-03 constraints on a merge apply unchanged.

**Two live cases he ruled at the same time. Both are CLOSED, and neither is an open defect.**

- **Arabic — RULED FINE.** `ara_for_eng` uses the **same bound morpheme for "I'm going to" and "I will"**: one Arabic future under two English glosses, **32 rows** as reported to him. **Kai's ruling: "this is fine!"** Recorded as ruled and closed. It is the harmless direction — several known prompts, one target (**K3**).
- **Italian — NOT A DEFECT, and the record is corrected here.** It was put to him as a *mirror-image* defect: one English gloss covering three Italian constructions, with *pagherai* reachable from both "going to pay" and "you'll pay". **He corrected that reading.** **MANY KNOWN PROMPTS MAPPING TO ONE TARGET STRING IS THE ALLOWED DIRECTION** for English-known / Italian-target. It is the reverse — **one prompt with several valid target answers** — that breaks ZUT. **Write it down so nobody re-raises it:** many-known→one-target is fine (**K3**, and the direction paragraph in **K2**: *"multiple knowns to one target is fine, other way is not"*); one-known→many-targets is the defect.
...
**P19 — Every new LEGO SHOULD have its own practice phrases, but never at the cost of another rule. Where the available LEGOs genuinely cannot produce valid ones, that is a FLAG, not automatically a defect; empty is the absolute last resort, and it obliges catch-up drilling at the next few LEGOs.** · **HARD (the ladder, and its ORDER), SOFT (how much "as much as possible" is in a given course)** · **Kai's ruling, 2026-09-08, closing clash C22** · A phrase written to fill a basket while breaking ZUT (**K22**) or reaching for an untaught form (**K14**, **P1**) is worse than no phrase at all; and an empty debut left empty teaches a chunk the learner never produces.

> "We should do everything we can for every new lego to have phrases, but never break other rules. Sometimes it's genuinely just not possible to have enough, or even any practice phrases with the available legos. In cases like that, it's good to flag it - there might be a way to break the legos differently so that it becomes possible. But as an absolute last resort, it can be empty. If it is empty, it should get as much drilling as possible as soon as possible, such as at the next few legos." — Kai, 2026-09-08

**It is a ladder, and the ordering is the whole point.** Take the rungs in order; you may only stand on a lower one having honestly tried the ones above it.

1. **Every new LEGO gets its own practice phrases.** This is the default and the target, not an aspiration — "do everything we can".
2. **Coverage never overrides another rule.** It is not a licence to build a phrase that breaks ZUT (**K22**, **P16**), uses an untaught form (**K14**, **K21**, **P1**, **P2**), fails to contain the whole LEGO (**P17**), or is manufactured by demoting a USE phrase (**P18**). **A rule-breaking practice phrase is worse than no practice phrase.**
3. **Where the available LEGOs genuinely cannot produce enough valid phrases — or any — that is a FLAG, not automatically a defect.** The count alone does not tell you which you are holding.
4. **The flag's first meaning is diagnostic: it may mean the LEGOs are cut wrong.** Before accepting the gap, ask whether a different decomposition — merging, growing, or reordering the chunks within the seed (**L2**, **L22**, **P7**) — would make valid phrases possible. **This is the most valuable thing the flag does.**
5. **Empty is permitted only as an ABSOLUTE LAST RESORT**, after 3 and 4 have honestly been tried and written down. "As an absolute last resort, it can be empty."
6. **An empty debut creates an obligation immediately after it; it does not discharge one.** The chunk "should get as much drilling as possible as soon as possible, such as at the next few legos" — front-loaded, not spread thin (**P12**).

**What this changes.** **P10** already said an unpractised LEGO is not taught and that the remedy is always to author more phrases; that stands unaltered as rungs 1 and 2. What P19 adds is the bottom of the ladder P10 did not have: an empty debut is **not automatically a defect**, and the two states that a bare count cannot tell apart — *empty, flagged, with the decomposition question asked and catch-up drilling present* versus *empty with nothing following* — are now **different states, and only the second is a defect**.

**How to check it.** No check enforces this ladder today. `scan-course` Check 16 counts phrases per new LEGO and reports "empty (0 build AND 0 use)" without looking at what follows, so it cannot distinguish rung 6 from a real gap — see GAPS. At the generation gate the arithmetic is stricter than the ladder and always has been: `services/course-builder/lib/phrase-structure.cjs` `checkBuildUsePhrases` **hard-blocks** a submission below 3 BUILD / 5 USE per LEGO from seed 4 onward (graduated for seeds 1–3), so **a deliberately empty basket cannot be submitted through `POST /api/seed/complete` at all**. That is a statement of what the code does, not a limit Kai placed on his ruling: the last-resort empty is reachable at fix time and in existing content, and whether the gate should learn the ladder is a question for him, not an inference to act on.
...
**K6 — The known side is tested by LEARNER PREDICTABILITY, not by string matching. One question: will the learner reach for the correct target word as the first thing?** · **HARD** · **Kai, 2026-08-17, bounded 2026-08-28, and sharpened by him on 2026-09-08 closing clash C24** · Kai, 2026-08-17: "Sometimes grammar in known is more complicated than the target… the known can use a different case, or conjugation, contraction, gender or whatever if it needs, even if it isn't introduced… They'll try with the closest thing they know, and be pleasantly surprised." · **The controlled-language constraint on the known side is about LEXEMES, not surface forms.** · **Restated and bounded by Kai, 2026-08-28:** "Known side - this is the one that can be a little looser… any slightly different forms like endings, mutations, conjugations, contractions are acceptable, **as long as the learner will easily connect the two concepts without having to think about it**." That last clause is the limit — the latitude is measured in the learner's effort, not in the grammar · **The TARGET side has its own, much tighter answer: K8.**

**Sharpened by Kai on 2026-09-08, closing clash C24 — and he noted he had answered it before, which he had: this is the same rule, stated as the test it always was.**

> "By English word, you mean Known word. I'm sure I have answered this before. It doesn't have to match exactly in the known language, if there is a clear connection between the two - **will the learner think of the correct target word as the first thing**, even if it isn't exactly the same thing they've been taught? Things like a Welsh speaker learning something, and a word if mutated in the known - it's still clearly the same word, and the learner will reach for the same target word they were taught to say with the unmutated introduction, it's absolutely fine. Something that's less obvious is the 'remember', 'remembering' one - it's possible the learner could perhaps worry for a moment, but they're still clearly going to say the word they know for 'remember' even if they're prompted for 'remembering', and then **they'll be pleasantly surprised that it *is* the same word - phew**. Things where it's not clearly the same word to the learner, even if they're the same word in target, are not ok - thinks like 'dysgu' in welsh - if the learner has been taught that 'to learn' is dysgu, we can't prompt the learner for 'to teach', there is no automatic connection between the two for an English speaker, even though it's the same word the learner already knows, **they couldn't produce it based on what they know. That means 'to teach' is off limits unless it comes up in a later seed.**" — Kai, 2026-09-08

**The test is the one question, and nothing else.** Not whether the known form matches a taught string. The known side is the language the learner already speaks; what matters is whether the prompt **routes them to the right target item**.

**PASSES:**
- **A mutated known-side form.** Obviously the same word; the learner reaches for the target word they were taught with the unmutated introduction. "It's absolutely fine."
- **An inflection of a taught word** — "remembering" against a taught "remember". His own reading is worth having in full: a moment's worry, then the word they know, then relief — *"they'll be pleasantly surprised that it is the same word - phew."* A moment's doubt is not a defect.

**FAILS — and this is the sharpest part of the ruling: IDENTITY IN THE TARGET DOES NOT LICENSE A KNOWN-SIDE PROMPT.** A known form the learner has no route to is off limits **even when the target word is one they already hold**. His example is decisive: Welsh *dysgu* is both "to learn" and "to teach". A learner taught that "to learn" is *dysgu* **cannot be prompted with "to teach"** — an English speaker has no automatic connection between the two, so they could not produce it from what they know, however identical the Welsh is. **"That means 'to teach' is off limits unless it comes up in a later seed."** The remedy is a later seed, never a claim that the word is already taught · This is **K14** reached from the known side: an unreachable prompt is unavailable, and the prompt is what is wrong.

**The target side is governed by a different and much stricter rule — K8**, exact matches on the whole with narrow barely-audible exceptions. **K21** — availability keyed on the exact surface form, no stemming and no derivation — is **the TARGET side's standard**; it is not the test for the known side · **Honest note on where this meets Tom's K21:** K21 is stated with known-side English examples, the build gate implements it on the known side (`validation.cjs` `stemKnownGloss`, "NO inflection allowance"), and on those examples Tom's ruling and this one reach different answers. **The code was deliberately not touched. See GAPS.**
...
**K8 — The TARGET side stays strict, always.** · **HARD** · Kai, 2026-08-17 · Every target sentence tiles from taught chunks, no exceptions. K6 and K7 are known-side latitude only. · **What may and may not vary, in his own words, 2026-08-28:** "Target side - no, infected [inflected] forms don't count, **it should be exactly the form introduced**. Very very slight differences, such as a mild softening mutation or a slightly different vowel ending… is acceptable because it's barely perceptible to a learner, but nothing more than that. **What is acceptable is that if the lego is more than one word, they can be broken up** (have a word put between the words in the lego) if needed. But all the words should be the same and in the same form as the lego." · **The split clause is the part a strict tiling check would read as a defect and must not:** a multi-word LEGO may have a word inserted between its words, provided every word is present and in the taught form. · **Restated by him on 2026-09-08, closing the target-side half of clash C24, with the exceptions named:** "Target-side is much less flexible. There are some exceptions for cases where there is barely any sound change (**some soft mutations in welsh, -o/-a endings in romance languages** as examples) but on the whole **we stick to exact matches**." Those two are his examples, not a closed list, and the measure is the same one as 2026-08-28 — barely any sound change · **The asymmetry is the point:** the known side is judged by whether the learner will reach for the right target word (**K6**); the target side is judged by the form itself. **K21** is where the target side's exactness is stated as a gate rule.

**On the split clause and word-order movement:** K8 permits a word to be inserted between a multi-word LEGO's words. **L25** is what follows from that — where the language routinely splits the chunk apart, the chunk is not re-cut; it is drilled harder.
...
**K11 — NO PARENTHETICAL TAGS in courses, ever.** · **HARD** · Kai, 2026-08-17: "they're a pet peeve of mine." · Register, plurality, grammar notes — all carried inside the sentence or not at all · **They also get spoken aloud**: bracketed English in narration is read to the learner exactly as written. When one word needs disambiguating, the answer is a **narrower plain gloss that survives being spoken** ("to know a person", not "to know (a person)") · **Kai ruled clash C3 on 2026-08-27: the ban stands, and removal is NEVER a sweep.**
...
**A13 — Displayed text, the presentation, and every voice must all express the same target form.** · **HARD** · Deborah, Welsh QA · Real instances: English and both voices say "pretty eyes", the Welsh text shows "llygaid blin" (*angry* eyes); presentation says "byth", text and one voice say "byth eto" · **No automatic check exists for any of this — see A21 for the defect class, and A22 for which artefact to repair.**
...
**His own remedy is a listening page, and he rules by ear — including in languages he does not speak:** "No need to do that. I've listened to them all - you built me a tool to listen to each phrase that includes 'blin'. All the audio said 'del' even though the audio text said blin. They all need to be rerecorded. no point checking again." (Kai, 2026-08-24) · So when this class is suspected, **build the listening surface and hand it to him** rather than reasoning from the tables · **A13, A14 and A15** are its specific shapes; none of them has a check · **Clash C21 closed on 2026-09-08 — the repair rule is at A22 and its upstream cause at A23.**

**A22 — When the spoken clip and the displayed text disagree, the TEXT is usually right and the CLIP is stale: the default repair is to regenerate the audio to match the text. But every mismatch is still investigated one by one.** · **HARD (the direction of the default, and the duty to investigate), SOFT (what any individual case turns out to be)** · **Kai's ruling, 2026-09-08, closing clash C21** · Editing the text to match the clip reverts a fix somebody already made, and does it silently — the learner ends up back on the wrong wording with no record that it was ever corrected.

> "usually when they don't match it's due to a past fix, that forgot to null and regenerate the audio. That means that more often than not, the text is correct. However it should always be investigated." — Kai, 2026-09-08

**The causal story is what makes this rule correct rather than arbitrary — read it before you apply the default.** A mismatch is normally the *fingerprint of an earlier text fix* whose audio was never nulled and regenerated. Somebody corrected the sentence; the clip was left speaking the old one. That is why the text is the newer artefact and the clip the stale one, and it is why the repair runs in that direction: **regenerate the audio to match the text, do not edit the text to match the clip.** The live example the clash was raised on — `pol_for_eng:S0240L03U04`, where the screen reads "I know someone who likes to talk" and the clip says "my mum likes talking in Polish" — has exactly that shape.

**"Usually" and "more often than not" are his words and they are deliberate.** This is a **strong default, not an automatic rewrite**. The other causes are real: TTS hallucination (**A21**), a clip linked to the wrong row, a voice that was never re-rendered after a decision went the other way. So:

- **Every mismatch is investigated individually — "it should always be investigated."** The default tells you where to start, not what you will find.
- **Never bulk-regenerate a mismatch list without reading it.** This is **R0.13** applied to audio: authored work over find-and-replace, and everything a mechanical pass touched is read back by hand, not sampled (**R0.5**). A mismatch count is not a work order (**R0.9**).
- **When you do regenerate, use A19's routes and delete nothing** (**A4**, **O11**). If the investigation concludes the *text* is the wrong artefact after all, that is a text change and it carries A19's second branch and every obligation in **O1**–**O3**.
- Where the class is suspected rather than proven, **A21** still applies: build the listening surface and let Kai rule by ear.

**A23 — A text fix that does not null and regenerate its audio MANUFACTURES an A22 mismatch. Sequencing the audio is part of the fix, not a follow-up.** · **HARD** · **Kai, 2026-09-08 — the upstream cause named inside his C21 ruling: "due to a past fix, that forgot to null and regenerate the audio"** · This is why the defect exists at all, and it is stated as a rule of its own so that fix work stops producing new instances of it · The mechanism is already written down and is not new: **A5** (the triggers mutate the link for you), **A6** (render first, then update the text), **A19** (which route, and delete nothing), **O3** and **O8** (check the link back; queue the audio pass). What A23 adds is the consequence of skipping them — **a silently wrong clip that will be found months later by a learner or by a reader of a mismatch list, with nothing in the tables to say which artefact was the corrected one.** A slot left honestly quiet is recoverable; a slot left speaking superseded words is not visible at all.
...
13. **The rulings written in on 2026-09-08 were harvested from conversation, not re-confirmed with Kai.** Each carries his verbatim words, the date and the conversation it came from, and was transcribed rather than interpreted. Three things the harvest could not settle and this document therefore did not — **the first of them was settled by Tom on 2026-09-08 and now lives at K22**; the second — whether **C25** genuinely conflicted with **L17** — **was ruled by Kai himself on 2026-09-08**: the ground is separability, not familiarity, and L17 was refined rather than overruled (**L25**). What remains is the four clashes he has never spoken to (**C11, C12, C18, C19**), where a pattern in his other rulings would predict an answer and has deliberately not been written down.

14. **The harvest's own arithmetic disagrees with itself by one, and the conservative reading was taken.** Its headline scored "15 RULED, 3 PARTLY RULED"; its per-clash verdicts and summary table give **14 RULED and 4 PARTLY** (C17, C20, C21, C22 — C22 has since been closed by his 2026-09-08 ladder ruling, P19). The per-item verdicts were followed, so C17 was **tightened rather than closed**. If Kai reads C17 as fully ruled, closing it is a one-line change.

18. **The build gate's known-side check now tests the wrong thing, and it was deliberately left alone.** Kai's 2026-09-08 ruling (**K6**, closing **C24**) makes the known side a predictability question; `services/course-builder/lib/validation.cjs` asks a string question. `stemKnownGloss` lowercases and strips non-letters and nothing else — its own comment says "EXACT-FORM normaliser (Tom 2026-06-15): NO inflection allowance" — `tokenizeKnown` splits the prompt into those tokens, and `checkKnownSide` rejects any token that is not a taught gloss, free glue, an NPI under negation, a do-auxiliary or licensed machinery. So it **would reject live content Kai has now ruled fine**: `spa_for_eng` carries five practice phrases using "remembering" against a LEGO taught as "to remember" — including "I'm not sure about remembering" — and under the exact-form normaliser "remembering" comes back as an unknown gloss. **Verified against the live database on 2026-09-08, not inferred.** **What it would need to become, in one paragraph:** the check cannot answer "will the learner reach for the right target word first" by itself, so the shape is a **narrow allowance plus a referral**, not a looser matcher — a per-pair contract clause naming the known-language form variation that is predictable in that pair (English *-s/-ed/-ing* and the contractions already expanded; Welsh initial mutations; Romance gender pairs — **K18**'s properly-scoped exemption mechanism, which Kai already asked to have scoped and which this is an instance of), applied only where the base form is attested, and everything outside that allowance still rejected. What it must **not** do is stem or lemmatise generally, because Kai's failing case — *dysgu* "to learn" versus "to teach" — is a **different lexeme in the known language pointing at the same target word**, and no morphological relaxation can distinguish it from a legitimate inflection; that judgement stays with a person (**K7**). **Nothing here was implemented and nothing was changed. Gate changes go through Tom, and this is the same K21 boundary GAPS records above.**

16. **No check can see the bottom of the P19 ladder.** `scan-course` Check 16 counts phrases per new LEGO and reports "empty" without looking at what follows it, so it cannot tell a permitted last-resort empty — flagged, decomposition questioned, drilled at the next few LEGOs — from a real gap. The rule now exists (**P19**); the check does not, and none was written here: **the code was deliberately left untouched.**

17. **The `is_new:false` orphans — 120 chunks with no genuine earlier teaching instance. RECORDED FOR LATER AT KAI'S EXPLICIT DIRECTION; NOT QUEUED FOR ACTION.** A probe across the nine paid English-known courses found **120 of 1,493 `is_new:false` chunks (8.0%)** whose credited earlier teaching instance is not one. The mechanism is single and reproducible: an atomic chunk at `lego_index` 1 was marked not-new by crediting a **larger same-seed sibling at `lego_index` 2 — a LATER position** — as the place it was already taught. Seeds 207 and 257 reproduce it across six to nine courses independently. Full data: https://watson-1.tail4968cb.ts.net/d/56ef03a9

    > "I don't really care about the orphan thing, but we can look at it at some point if you write it down somewhere. I think 'amigo' should be new if the learner's only been taught 'mis amigos'. But it's not serious. And for the legos that get introduced later in the same seed as part of a larger lego, it sounds like the smaller 'Not_new' lego should just be deleted. rather than be flagged as not new" — Kai, 2026-09-08

    Three things come out of that, and they are **deliberately kept apart**:

    - **PRIORITY — he has explicitly deprioritised it.** "I don't really care… But it's not serious." It is written down here because he asked for it to be written down somewhere, **to be picked up at some point, not because it is scheduled.** Nothing should be dispatched off this entry and nothing here says it is planned.
    - **A RULE he gave in passing, and it IS a canon rule: a different surface form is a NEW item.** "I think 'amigo' should be new if the learner's only been taught 'mis amigos'." This is **K21** — availability is keyed on the exact surface form, no stemming, no derivation — restated from the *availability* side: having been shown "mis amigos" does not make "amigo" taught, so its debut is genuine and `is_new` should say so. See **K21**; it is not duplicated here.
    - **HIS PROPOSED REMEDY, recorded as his direction for whenever this is picked up:** where a smaller chunk is introduced later in the **same seed** as part of a larger chunk, the smaller not-new chunk "should just be deleted. rather than be flagged as not new". **Recorded as his stated preference, and honestly: it has not been costed, tested, or validated against the 120 rows.** Nobody has checked how many of the 120 are that shape, what deleting a LEGO does to the phrases, decompositions, audio and round index that hang off it (**O1**, **O2**, **O6**, **L1**), or whether the round-numbering consequences are acceptable. **It is a direction, not a plan.**
